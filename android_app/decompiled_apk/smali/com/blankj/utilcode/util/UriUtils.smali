...
.method public static file2Uri(Ljava/io/File;)Landroid/net/Uri;
    ...
    const-string v0, "Argument \'file\' of type File (#0 out of 1, zero-based) is marked by @android.support.annotation.NonNull but got null for it"
...
.method private static getFileFromUri(Landroid/net/Uri;I)Ljava/io/File;
    .locals 1

    const/4 v0, 0x0

    .line 112
    invoke-static {p0, v0, v0, p1}, Lcom/blankj/utilcode/util/UriUtils;->getFileFromUri(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;I)Ljava/io/File;
...
.method private static getFileFromUri(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;I)Ljava/io/File;
    .locals 7
...
.method public static uri2File(Landroid/net/Uri;)Ljava/io/File;
    ...
    const-string p0, " parse failed. -> 0"
    ...
    const-string p0, " parse failed. -> 1"
    ...
    .line 78
    invoke-static {p0, v0}, Lcom/blankj/utilcode/util/UriUtils;->getFileFromUri(Landroid/net/Uri;I)Ljava/io/File;
    ...
    .line 96
    invoke-static {p0, v2, v1, v0}, Lcom/blankj/utilcode/util/UriUtils;->getFileFromUri(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;I)Ljava/io/File;
    ...
    const-string p0, " parse failed. -> 3"
    ...
    const-string p0, " parse failed. -> 6"
    ...
    const-string p0, " parse failed. -> 8"
