...
public class RoundProgressBar extends View {
    ...
    private void init(AttributeSet attributeSet) {
        TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, R.styleable.RoundProgressBar);
        this.mWidth = typedArrayObtainStyledAttributes.getDimensionPixelOffset(R.styleable.RoundProgressBar_rpb_width, this.mWidth);
        this.mColor = typedArrayObtainStyledAttributes.getColor(R.styleable.RoundProgressBar_rpb_color, this.mColor);
        this.mBackground = typedArrayObtainStyledAttributes.getColor(R.styleable.RoundProgressBar_rpb_background, this.mBackground);
        this.mProgress = typedArrayObtainStyledAttributes.getFloat(R.styleable.RoundProgressBar_rpb_progress, this.mProgress);
        this.mMaxProgress = typedArrayObtainStyledAttributes.getFloat(R.styleable.RoundProgressBar_rpb_max_progress, this.mMaxProgress);
        this.mBgWidth = typedArrayObtainStyledAttributes.getDimensionPixelOffset(R.styleable.RoundProgressBar_rpb_background_width, this.mBgWidth);
