...
import cn.highlight.tx.listener.OnOpen;
import cn.highlight.tx.listener.OnOpenSerialPortListener;
import cn.highlight.tx.listener.OnSerialPortDataListener;
import cn.highlight.tx.serialport.SerialPortTxManager;
import cn.highlight.tx.usb.SerialInputOutputManager;
import cn.highlight.tx.usb.UsbSerialDriver;
import cn.highlight.tx.usb.UsbSerialPort;
import cn.highlight.tx.usb.UsbSerialProber;
import cn.highlight.tx.utils.TxUtil;
...
public class BaseTxManager {
    ...
    public SerialPortTxManager init232SerialPort(File file, int i) {
        ...
        this.mSerialPortManager.setOnOpenSerialPortListener(new OnOpenSerialPortListener() { // from class: cn.highlight.tx.BaseTxManager.1
            @Override // cn.highlight.tx.listener.OnOpenSerialPortListener
            ...
            public void onFail(File file2, OnOpenSerialPortListener.Status status) {
                if (AnonymousClass7.$SwitchMap$cn$highlight$tx$listener$OnOpenSerialPortListener$Status[status.ordinal()] != 1) {
                    if (BaseTxManager.this.onOpen != null) {
        ...
        this.mSerialPortManager.setOnSerialPortDataListener(new OnSerialPortDataListener() { // from class: cn.highlight.tx.BaseTxManager.2
            @Override // cn.highlight.tx.listener.OnSerialPortDataListener
    ...
    /* renamed from: cn.highlight.tx.BaseTxManager$7, reason: invalid class name */
    static /* synthetic */ class AnonymousClass7 {
        static final /* synthetic */ int[] $SwitchMap$cn$highlight$tx$listener$OnOpenSerialPortListener$Status = new int[OnOpenSerialPortListener.Status.values().length];

        static {
            try {
                $SwitchMap$cn$highlight$tx$listener$OnOpenSerialPortListener$Status[OnOpenSerialPortListener.Status.NO_READ_WRITE_PERMISSION.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$cn$highlight$tx$listener$OnOpenSerialPortListener$Status[OnOpenSerialPortListener.Status.OPEN_FAIL.ordinal()] = 2;
    ...
    /* renamed from: cn.highlight.tx.BaseTxManager$3, reason: invalid class name */
    class AnonymousClass3 extends BleGattCallback {
        final /* synthetic */ OnConnStatus val$onConnStatus;

        @Override // cn.highlight.tx.ble.callback.BleGattCallback
        public void onStartConnect() {
        }

        AnonymousClass3(OnConnStatus onConnStatus) {
        ...
        public void onConnectSuccess(final BleDevice bleDevice, BluetoothGatt bluetoothGatt, int i) {
            BleManager.getInstance().setMtu(bleDevice, 247, new BleMtuChangedCallbackHighlight() { // from class: cn.highlight.tx.BaseTxManager.3.1
                @Override // cn.highlight.tx.ble.callback.BleMtuChangedCallbackHighlight
    ...
    public void conn(BleDevice bleDevice, OnConnStatus onConnStatus) {
        BleManager.getInstance().connect(bleDevice, new AnonymousClass3(onConnStatus));
    }
    ...
    public void oPenNotify(BleDevice bleDevice) throws InterruptedException {
        ...
        BleManager.getInstance().notify(bleDevice, UUID_SERVICE, UUID_NOTIFY, new BleNotifyCallbackHighlight() { // from class: cn.highlight.tx.BaseTxManager.4
            @Override // cn.highlight.tx.ble.callback.BleNotifyCallbackHighlight
