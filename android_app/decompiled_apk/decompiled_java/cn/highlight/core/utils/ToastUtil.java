...
public class ToastUtil {
    ...
    private static View getView(Context context, String str) {
        View viewInflate = LayoutInflater.from(context).inflate(R.layout.item_toast, (ViewGroup) null);
        ((TextView) viewInflate.findViewById(R.id.tv_toast)).setText(str);
        return viewInflate;
    }

    private static View getView(Context context, int i) {
        View viewInflate = LayoutInflater.from(context).inflate(R.layout.item_toast, (ViewGroup) null);
        ((TextView) viewInflate.findViewById(R.id.tv_toast)).setText(context.getResources().getString(i));
        return viewInflate;
    }

    private static View getCentreView(Context context, String str) {
        View viewInflate = LayoutInflater.from(context).inflate(R.layout.item_toast_centre, (ViewGroup) null);
        ((TextView) viewInflate.findViewById(R.id.tv_toast)).setText(str);
        return viewInflate;
    }
