...
public class AlertDialog {
    ...
    public AlertDialog builder() {
        ...
        this.txt_title = (TextView) viewInflate.findViewById(R.id.txt_title);
        this.txt_title.setVisibility(8);
        this.txt_msg = (TextView) viewInflate.findViewById(R.id.txt_msg);
        this.txt_msg.setVisibility(8);
        this.txt_hint = (TextView) viewInflate.findViewById(R.id.txt_hint);
        this.txt_hint.setVisibility(8);
        this.btn_neg = (Button) viewInflate.findViewById(R.id.btn_neg);
        this.btn_neg.setVisibility(8);
        this.btn_pos = (Button) viewInflate.findViewById(R.id.btn_pos);
        this.btn_pos.setVisibility(8);
        this.img_line = (ImageView) viewInflate.findViewById(R.id.img_line);
