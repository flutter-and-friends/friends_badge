...
public class ModelBgAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new ViewHolder(LayoutInflater.from(this.context).inflate(R.layout.adapter_model_bg_item, viewGroup, false));
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public void onBindViewHolder(ViewHolder viewHolder, final int i) {
        Drawable drawable;
        viewHolder.item.setBackgroundResource(R.drawable.shape_so_bai2_st_0_co_5);
        if (this.type.equals(this.dataList.get(i))) {
            viewHolder.item.setBackgroundResource(R.drawable.model_bg_selected_co_5);
        }
        if (this.context.getResources().getString(R.string.model_bg_black).equals(this.dataList.get(i))) {
            drawable = this.context.getDrawable(R.drawable.shape_so_hei_st_0_co_5);
        } else if (this.context.getResources().getString(R.string.model_bg_yellow).equals(this.dataList.get(i))) {
            drawable = this.context.getDrawable(R.drawable.shape_so_huang_st_0_co_5);
        } else if (this.context.getResources().getString(R.string.model_bg_red).equals(this.dataList.get(i))) {
            drawable = this.context.getDrawable(R.drawable.shape_so_hong_st_0_co_5);
        } else {
            drawable = this.context.getDrawable(R.drawable.shape_so_bai_st_0_co_5);
        }
        if (drawable != null) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View view) {
            ...
            this.item_bg = (TextView) view.findViewById(R.id.item_bg);
