...
public class ApiUtil {
    ...
    public void testConn(Activity activity, String str, final ApiResult<Result> apiResult) {
        ...
        if (!Tools.isValidUrl(str2)) {
            ToastUtil.showToast(activity, activity.getResources().getString(R.string.url_error));
        } else {
            loadingUtil.showProgressDialog(activity, activity.getResources().getString(R.string.test_connect));
    ...
    public void login(Activity activity, String str, String str2, final ApiResult<LoginRes> apiResult) {
        ...
        loadingUtil.showProgressDialog(activity, activity.getResources().getString(R.string.logging_in));
