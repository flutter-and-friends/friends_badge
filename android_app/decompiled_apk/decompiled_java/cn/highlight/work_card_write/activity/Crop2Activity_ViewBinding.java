...
public class Crop2Activity_ViewBinding implements Unbinder {
    ...
    public Crop2Activity_ViewBinding(final Crop2Activity crop2Activity, View view) {
        ...
        crop2Activity.cropView = (CropImageView) Utils.findRequiredViewAsType(view, R.id.cropView, "field 'cropView'", CropImageView.class);
        View viewFindRequiredView = Utils.findRequiredView(view, R.id.tvCancel, "field 'tvCancel' and method 'onViewClicked'");
        crop2Activity.tvCancel = (TextView) Utils.castView(viewFindRequiredView, R.id.tvCancel, "field 'tvCancel'", TextView.class);
        ...
        View viewFindRequiredView2 = Utils.findRequiredView(view, R.id.tvSure, "field 'tvSure' and method 'onViewClicked'");
        crop2Activity.tvSure = (TextView) Utils.castView(viewFindRequiredView2, R.id.tvSure, "field 'tvSure'", TextView.class);
