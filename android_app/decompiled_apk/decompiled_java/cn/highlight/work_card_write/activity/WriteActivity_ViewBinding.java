...
public class WriteActivity_ViewBinding implements Unbinder {
    ...
    public WriteActivity_ViewBinding(final WriteActivity writeActivity, View view) {
        ...
        writeActivity.imgBack = (ImageView) Utils.castView(viewFindRequiredView, R.id.imgBack, "field 'imgBack'", ImageView.class);
        ...
        View viewFindRequiredView2 = Utils.findRequiredView(view, R.id.imgHome, "field 'imgHome' and method 'onViewClicked'");
        writeActivity.imgHome = (ImageView) Utils.castView(viewFindRequiredView2, R.id.imgHome, "field 'imgHome'", ImageView.class);
        ...
        writeActivity.slideSwitch = (SlideSwitchView) Utils.findRequiredViewAsType(view, R.id.slideSwitch, "field 'slideSwitch'", SlideSwitchView.class);
        writeActivity.editColorLinear = (LinearLayout) Utils.findRequiredViewAsType(view, R.id.editColorLinear, "field 'editColorLinear'", LinearLayout.class);
        writeActivity.rfRecyclerView = (RecyclerView) Utils.findRequiredViewAsType(view, R.id.rfRecyclerView, "field 'rfRecyclerView'", RecyclerView.class);
        writeActivity.image = (ImageView) Utils.findRequiredViewAsType(view, R.id.image, "field 'image'", ImageView.class);
        writeActivity.tvProgress = (TextView) Utils.findRequiredViewAsType(view, R.id.tvProgress, "field 'tvProgress'", TextView.class);
        writeActivity.progressBar = (ZzHorizontalProgressBar) Utils.findRequiredViewAsType(view, R.id.progressBar, "field 'progressBar'", ZzHorizontalProgressBar.class);
        View viewFindRequiredView3 = Utils.findRequiredView(view, R.id.btnSave, "field 'btnSave' and method 'onViewClicked'");
        writeActivity.btnSave = (TextView) Utils.castView(viewFindRequiredView3, R.id.btnSave, "field 'btnSave'", TextView.class);
        ...
        View viewFindRequiredView4 = Utils.findRequiredView(view, R.id.btnWrite, "field 'btnWrite' and method 'onViewClicked'");
        writeActivity.btnWrite = (TextView) Utils.castView(viewFindRequiredView4, R.id.btnWrite, "field 'btnWrite'", TextView.class);
