...
.method public constructor <init>(Lrx/Subscriber;)V
    ...
    iput-object p1, p0, Lrx/internal/operators/OnSubscribeFromAsyncEmitter$LatestAsyncEmitter;->queue:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iput-object p1, p0, Lrx/internal/operators/OnSubscribeFromAsyncEmitter$LatestAsyncEmitter;->wip:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method drain()V
    ...
    .line 489
    iget-object v1, v0, Lrx/internal/operators/OnSubscribeFromAsyncEmitter$LatestAsyncEmitter;->wip:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    .line 494
    :cond_0
    iget-object v1, v0, Lrx/internal/operators/OnSubscribeFromAsyncEmitter$LatestAsyncEmitter;->actual:Lrx/Subscriber;

    .line 495
    iget-object v2, v0, Lrx/internal/operators/OnSubscribeFromAsyncEmitter$LatestAsyncEmitter;->queue:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 498
    :cond_1
    invoke-virtual/range {p0 .. p0}, Lrx/internal/operators/OnSubscribeFromAsyncEmitter$LatestAsyncEmitter;->get()J
    ...
    .line 507
    :cond_2
    iget-boolean v14, v0, Lrx/internal/operators/OnSubscribeFromAsyncEmitter$LatestAsyncEmitter;->done:Z
    ...
    .line 514
    iget-object v1, v0, Lrx/internal/operators/OnSubscribeFromAsyncEmitter$LatestAsyncEmitter;->error:Ljava/lang/Throwable;

    if-eqz v1, :cond_4

    .line 516
    invoke-super {v0, v1}, Lrx/internal/operators/OnSubscribeFromAsyncEmitter$BaseAsyncEmitter;->onError(Ljava/lang/Throwable;)V

    goto :goto_2

    .line 518
    :cond_4
    invoke-super/range {p0 .. p0}, Lrx/internal/operators/OnSubscribeFromAsyncEmitter$BaseAsyncEmitter;->onCompleted()V
    ...
    .line 538
    :cond_8
    iget-boolean v5, v0, Lrx/internal/operators/OnSubscribeFromAsyncEmitter$LatestAsyncEmitter;->done:Z
    ...
    .line 557
    :cond_c
    iget-object v5, v0, Lrx/internal/operators/OnSubscribeFromAsyncEmitter$LatestAsyncEmitter;->wip:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    .line 466
    iput-boolean p1, p0, Lrx/internal/operators/OnSubscribeFromAsyncEmitter$LatestAsyncEmitter;->done:Z
