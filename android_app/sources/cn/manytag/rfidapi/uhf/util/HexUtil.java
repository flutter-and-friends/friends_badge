...
public class HexUtil {
    ...
    public static byte IntToHex(Integer num) {
        try {
            ...
            return C0715d.m264a(hexString.toCharArray())[0];
        } catch (Exception e) {
            e.printStackTrace();
            return (byte) 0;
        }
    ...
    public static byte[] IntToHexS(Integer num) {
        try {
            ...
            return C0715d.m264a(hexString.toCharArray());
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static int hexTo10(byte[] bArr) {
        return Integer.decode("0x" + C0715d.m268b(bArr)).intValue();
    }
    ...
    public static long hexTo10L(byte[] bArr) {
        return Long.decode("0x" + C0715d.m268b(bArr)).longValue();
    }
}
