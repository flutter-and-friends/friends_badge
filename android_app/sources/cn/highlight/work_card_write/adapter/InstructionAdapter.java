...
public class InstructionAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            viewInflate = LayoutInflater.from(this.context).inflate(C0498R.layout.adapter_instruction_item, (ViewGroup) null);
            viewHolder.ivImg = (ImageView) viewInflate.findViewById(C0498R.id.ivImg);
