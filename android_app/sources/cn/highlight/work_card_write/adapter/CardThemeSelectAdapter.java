...
public class CardThemeSelectAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new ViewHolder(LayoutInflater.from(this.context).inflate(C0498R.layout.adapter_card_item2, viewGroup, false));
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View view) {
            super(view);
            this.cardView = (CardView) view.findViewById(C0498R.id.cardView);
            this.ivImg = (ImageView) view.findViewById(C0498R.id.ivImg);
            this.imgUnSelect = (ImageView) view.findViewById(C0498R.id.imgUnSelect);
            this.imgSelected = (ImageView) view.findViewById(C0498R.id.imgSelected);
        }
    }
