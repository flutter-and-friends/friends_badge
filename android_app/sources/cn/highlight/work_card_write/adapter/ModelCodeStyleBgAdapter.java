...
public class ModelCodeStyleBgAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new ViewHolder(LayoutInflater.from(this.context).inflate(C0498R.layout.adapter_model_code_style_item, viewGroup, false));
    }
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int i) {
        ...
        if ("透明".equals(this.dataList.get(i))) {
            ...
            if (this.otherType.equals("黑色")) {
                drawable = this.context.getDrawable(C0498R.drawable.shape_so_hei1_st_0_co_20);
            } else {
            ...
            if (this.otherType.equals("黄色")) {
                drawable = this.context.getDrawable(C0498R.drawable.shape_so_huang1_st_0_co_20);
            } else {
            ...
            if (this.otherType.equals("红色")) {
                drawable = this.context.getDrawable(C0498R.drawable.shape_so_hong1_st_0_co_20);
            } else {
                drawable = this.context.getDrawable(C0498R.drawable.shape_so_hong_st_0_co_20);
            }
        } else if (this.otherType.equals("白色")) {
            drawable = this.context.getDrawable(C0498R.drawable.shape_so_bai1_st_0_co_20);
        } else {
