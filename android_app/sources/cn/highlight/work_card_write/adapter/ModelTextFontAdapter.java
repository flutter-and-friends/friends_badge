...
public class ModelTextFontAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new ViewHolder(LayoutInflater.from(this.context).inflate(C0498R.layout.adapter_model_text_font_item, viewGroup, false));
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public void onBindViewHolder(ViewHolder viewHolder, final int i) {
        viewHolder.item_font.setBackgroundResource(C0498R.drawable.shape_so_bai2_st_0_co_5);
        if (this.type.equals(this.dataList.get(i))) {
            viewHolder.item_font.setBackgroundResource(C0498R.drawable.model_text_font_selected);
        }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View view) {
            ...
            this.item_font = (TextView) view.findViewById(C0498R.id.item_font);
            this.item_font_tv = (TextView) view.findViewById(C0498R.id.item_font_tv);
        }
    }
}
