...
public class ModelMainAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new ViewHolder(LayoutInflater.from(this.context).inflate(C0498R.layout.adapter_model_main_set_item, viewGroup, false));
    }
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int i) throws Resources.NotFoundException {
        Drawable drawable;
        if (i == 0) {
            drawable = this.context.getResources().getDrawable(C0498R.mipmap.model_bg);
        } else if (i == 1) {
            drawable = this.context.getResources().getDrawable(C0498R.mipmap.model_text);
        } else if (i == 2) {
            drawable = this.context.getResources().getDrawable(C0498R.mipmap.model_image);
        } else if (i == 3) {
            drawable = this.context.getResources().getDrawable(C0498R.mipmap.model_qrcode);
        } else if (i == 4) {
            drawable = this.context.getResources().getDrawable(C0498R.mipmap.model_barcode);
        } else if (i == 5) {
            drawable = this.context.getResources().getDrawable(C0498R.mipmap.model_shape);
        } else {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View view) {
            ...
            this.item_img = (ImageView) view.findViewById(C0498R.id.item_img);
            this.item_name = (TextView) view.findViewById(C0498R.id.item_name);
        }
    }
}
