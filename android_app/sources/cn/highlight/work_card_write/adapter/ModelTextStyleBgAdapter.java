...
public class ModelTextStyleBgAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public ModelTextStyleBgAdapter(Context context) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int i) {
        ...
        if ("透明".equals(this.dataList.get(i))) {
            RoundedBitmapDrawable roundedBitmapDrawableCreate = RoundedBitmapDrawableFactory.create(this.context.getResources(), BitmapFactory.decodeResource(this.context.getResources(), C0498R.mipmap.model_text_style_bg));
        ...
        viewHolder.item.setOnClickListener(new View.OnClickListener() { // from class: cn.highlight.work_card_write.adapter.-$$Lambda$ModelTextStyleBgAdapter$aPVMVhlKbUziaDVJ_PFck2MTP5w
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$onBindViewHolder$0$ModelTextStyleBgAdapter(i, view);
            }
        });
    }

    public /* synthetic */ void lambda$onBindViewHolder$0$ModelTextStyleBgAdapter(int i, View view) {
