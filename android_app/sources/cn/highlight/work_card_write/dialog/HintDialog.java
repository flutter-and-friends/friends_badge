...
public class HintDialog extends BaseDialog {
    ...
    @BindView(C0498R.id.btn_cancel)
    Button btnCancel;

    @BindView(C0498R.id.btn_sure)
    Button btnSure;
    ...
    @BindView(C0498R.id.img_line)
    ImageView imgLine;

    @BindView(C0498R.id.ll_dialog)
    LinearLayout llDialog;
    private OnHintDialogListener mListener;

    @BindView(C0498R.id.tv_msg)
    TextView tvMsg;
    ...
    protected int getLayoutId() {
        return C0498R.layout.dialog_hint;
    }
