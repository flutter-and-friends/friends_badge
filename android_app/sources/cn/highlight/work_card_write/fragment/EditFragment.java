...
public class EditFragment extends BaseFragment {
    ...
    @BindView(C0498R.id.linearAlbum)
    RelativeLayout linearAlbum;

    @BindView(C0498R.id.linearMore)
    LinearLayout linearMore;

    @BindView(C0498R.id.linearNew)
    LinearLayout linearNew;

    @BindView(C0498R.id.linearPhoto)
    RelativeLayout linearPhoto;

    @BindView(C0498R.id.linearZWSJ)
    LinearLayout linearZWSJ;

    @BindView(C0498R.id.newUserRecyclerView)
    ...
    protected int setLayoutId() {
        return C0498R.layout.fragment_edit;
    }
    ...
    @OnClick({C0498R.id.linearNew, C0498R.id.linearPhoto, C0498R.id.linearAlbum, C0498R.id.linearMore})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case C0498R.id.linearAlbum /* 2131296631 */:
                this.type = 2;
                showStartNFCDialog();
                initNFC();
                break;
            case C0498R.id.linearMore /* 2131296650 */:
                ((HomeActivity) Objects.requireNonNull(getActivity())).setUI(1);
                ((HomeActivity) getActivity()).setFragment(1);
                Constants.cardShowPage = "主题";
                break;
            case C0498R.id.linearNew /* 2131296652 */:
                showTypeDialog();
                break;
            case C0498R.id.linearPhoto /* 2131296656 */:
                this.type = 1;
                showStartNFCDialog();
                initNFC();
                break;
    ...
    private void showTypeDialog() {
        View viewInflate = LayoutInflater.from(getContext()).inflate(C0498R.layout.dialog_select_edit_item, (ViewGroup) null);
        LinearLayout linearLayout = (LinearLayout) viewInflate.findViewById(C0498R.id.linearNew);
        LinearLayout linearLayout2 = (LinearLayout) viewInflate.findViewById(C0498R.id.linearNew1);
        TextView textView = (TextView) viewInflate.findViewById(C0498R.id.textCancel);
        this.typeDialog = new BottomSheetDialog((Context) Objects.requireNonNull(getContext()), C0498R.style.CustomBottomSheetStyle);
