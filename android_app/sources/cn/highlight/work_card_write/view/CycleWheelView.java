...
public class CycleWheelView extends ListView {
    ...
    private void init() {
        ...
        this.mItemLayoutId = C0498R.layout.item_cyclewheel;
        this.mItemLabelTvId = C0498R.id.tv_label_item_wheel;
    ...
    public class CustomCycleWheelViewAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            TextView textView = (TextView) view.findViewById(CycleWheelView.this.mItemLabelTvId);
            TextView textView2 = (TextView) view.findViewById(C0498R.id.custom_tv_black);
            TextView textView3 = (TextView) view.findViewById(C0498R.id.custom_tv_white);
            TextView textView4 = (TextView) view.findViewById(C0498R.id.custom_tv_red);
            TextView textView5 = (TextView) view.findViewById(C0498R.id.custom_tv_yellow);
            if (i >= CycleWheelView.this.mWheelSize / 2 && (CycleWheelView.this.cylceEnable || i < this.mData.size() + (CycleWheelView.this.mWheelSize / 2))) {
                textView.setText(this.mData.get((i - (CycleWheelView.this.mWheelSize / 2)) % this.mData.size()));
