...
public class ServiceActivity_ViewBinding implements Unbinder {
    ...
    public ServiceActivity_ViewBinding(final ServiceActivity serviceActivity, View view) {
        ...
        serviceActivity.tvTitleBase = (TextView) Utils.findRequiredViewAsType(view, C0498R.id.tv_title_base, "field 'tvTitleBase'", TextView.class);
        serviceActivity.ivBack = (ImageView) Utils.findRequiredViewAsType(view, C0498R.id.iv_back, "field 'ivBack'", ImageView.class);
        serviceActivity.editAddress = (EditText) Utils.findRequiredViewAsType(view, C0498R.id.edit_address, "field 'editAddress'", EditText.class);
        View viewFindRequiredView = Utils.findRequiredView(view, C0498R.id.btn_connect, "field 'btnConnect' and method 'onViewClicked'");
        serviceActivity.btnConnect = (Button) Utils.castView(viewFindRequiredView, C0498R.id.btn_connect, "field 'btnConnect'", Button.class);
