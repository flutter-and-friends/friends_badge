...
public class IdentityActivity_ViewBinding implements Unbinder {
    ...
    public IdentityActivity_ViewBinding(final IdentityActivity identityActivity, View view) {
        ...
        View viewFindRequiredView = Utils.findRequiredView(view, C0498R.id.rl_enterprise, "field 'rlEnterprise' and method 'onViewClicked'");
        identityActivity.rlEnterprise = (RelativeLayout) Utils.castView(viewFindRequiredView, C0498R.id.rl_enterprise, "field 'rlEnterprise'", RelativeLayout.class);
        ...
        View viewFindRequiredView2 = Utils.findRequiredView(view, C0498R.id.rl_person, "field 'rlPerson' and method 'onViewClicked'");
        identityActivity.rlPerson = (RelativeLayout) Utils.castView(viewFindRequiredView2, C0498R.id.rl_person, "field 'rlPerson'", RelativeLayout.class);
        ...
        View viewFindRequiredView3 = Utils.findRequiredView(view, C0498R.id.iv_to, "field 'ivTo' and method 'onViewClicked'");
        identityActivity.ivTo = (ImageView) Utils.castView(viewFindRequiredView3, C0498R.id.iv_to, "field 'ivTo'", ImageView.class);
