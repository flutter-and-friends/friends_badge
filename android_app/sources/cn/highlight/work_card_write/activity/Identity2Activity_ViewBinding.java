...
public class Identity2Activity_ViewBinding implements Unbinder {
    ...
    public Identity2Activity_ViewBinding(final Identity2Activity identity2Activity, View view) {
        ...
        identity2Activity.imgBack = (ImageView) Utils.castView(viewFindRequiredView, C0498R.id.imgBack, "field 'imgBack'", ImageView.class);
        ...
        View viewFindRequiredView2 = Utils.findRequiredView(view, C0498R.id.radio_enterprise, "field 'radioEnterprise' and method 'onViewClicked'");
        identity2Activity.radioEnterprise = (RadioButton) Utils.castView(viewFindRequiredView2, C0498R.id.radio_enterprise, "field 'radioEnterprise'", RadioButton.class);
        ...
        View viewFindRequiredView3 = Utils.findRequiredView(view, C0498R.id.linear_enterprise, "field 'linearEnterprise' and method 'onViewClicked'");
        identity2Activity.linearEnterprise = (LinearLayout) Utils.castView(viewFindRequiredView3, C0498R.id.linear_enterprise, "field 'linearEnterprise'", LinearLayout.class);
        ...
        View viewFindRequiredView4 = Utils.findRequiredView(view, C0498R.id.radio_person, "field 'radioPerson' and method 'onViewClicked'");
        identity2Activity.radioPerson = (RadioButton) Utils.castView(viewFindRequiredView4, C0498R.id.radio_person, "field 'radioPerson'", RadioButton.class);
        ...
        View viewFindRequiredView5 = Utils.findRequiredView(view, C0498R.id.linear_person, "field 'linearPerson' and method 'onViewClicked'");
        identity2Activity.linearPerson = (LinearLayout) Utils.castView(viewFindRequiredView5, C0498R.id.linear_person, "field 'linearPerson'", LinearLayout.class);
        ...
        View viewFindRequiredView6 = Utils.findRequiredView(view, C0498R.id.btnSave, "field 'btnSave' and method 'onViewClicked'");
        identity2Activity.btnSave = (TextView) Utils.castView(viewFindRequiredView6, C0498R.id.btnSave, "field 'btnSave'", TextView.class);
