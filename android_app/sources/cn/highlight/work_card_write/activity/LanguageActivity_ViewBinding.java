...
public class LanguageActivity_ViewBinding implements Unbinder {
    ...
    public LanguageActivity_ViewBinding(final LanguageActivity languageActivity, View view) {
        ...
        languageActivity.imgBack = (ImageView) Utils.castView(viewFindRequiredView, C0498R.id.imgBack, "field 'imgBack'", ImageView.class);
        ...
        View viewFindRequiredView2 = Utils.findRequiredView(view, C0498R.id.linearEn, "field 'linearEn' and method 'onViewClicked'");
        languageActivity.linearEn = (LinearLayout) Utils.castView(viewFindRequiredView2, C0498R.id.linearEn, "field 'linearEn'", LinearLayout.class);
        ...
        View viewFindRequiredView3 = Utils.findRequiredView(view, C0498R.id.radioEn, "field 'radioEn' and method 'onViewClicked'");
        languageActivity.radioEn = (RadioButton) Utils.castView(viewFindRequiredView3, C0498R.id.radioEn, "field 'radioEn'", RadioButton.class);
        ...
        View viewFindRequiredView4 = Utils.findRequiredView(view, C0498R.id.linearZh, "field 'linearZh' and method 'onViewClicked'");
        languageActivity.linearZh = (LinearLayout) Utils.castView(viewFindRequiredView4, C0498R.id.linearZh, "field 'linearZh'", LinearLayout.class);
        ...
        View viewFindRequiredView5 = Utils.findRequiredView(view, C0498R.id.radioZh, "field 'radioZh' and method 'onViewClicked'");
        languageActivity.radioZh = (RadioButton) Utils.castView(viewFindRequiredView5, C0498R.id.radioZh, "field 'radioZh'", RadioButton.class);
        ...
        View viewFindRequiredView6 = Utils.findRequiredView(view, C0498R.id.linearDe, "field 'linearDe' and method 'onViewClicked'");
        languageActivity.linearDe = (LinearLayout) Utils.castView(viewFindRequiredView6, C0498R.id.linearDe, "field 'linearDe'", LinearLayout.class);
        ...
        View viewFindRequiredView7 = Utils.findRequiredView(view, C0498R.id.radioDe, "field 'radioDe' and method 'onViewClicked'");
        languageActivity.radioDe = (RadioButton) Utils.castView(viewFindRequiredView7, C0498R.id.radioDe, "field 'radioDe'", RadioButton.class);
        ...
        View viewFindRequiredView8 = Utils.findRequiredView(view, C0498R.id.btnSave, "field 'btnSave' and method 'onViewClicked'");
        languageActivity.btnSave = (TextView) Utils.castView(viewFindRequiredView8, C0498R.id.btnSave, "field 'btnSave'", TextView.class);
