...
public class CropActivity extends BaseActivity {
    ...
    @BindView(C0498R.id.img_turn_left)
    ImageView img_turn_left;

    @BindView(C0498R.id.img_turn_right)
    ...
    protected int setLayoutId() {
        return C0498R.layout.activity_crop;
    }
    ...
    */
    ...
    @OnClick({C0498R.id.img_turn_left, C0498R.id.img_turn_right, C0498R.id.tvCancel, C0498R.id.tvSure})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case C0498R.id.img_turn_left /* 2131296591 */:
                ...
                break;
            case C0498R.id.img_turn_right /* 2131296592 */:
                ...
                break;
            case C0498R.id.tvCancel /* 2131296931 */:
                deleteOriginalImage();
                Constants.editCropImage = null;
                finishActivity();
                break;
            case C0498R.id.tvSure /* 2131296942 */:
