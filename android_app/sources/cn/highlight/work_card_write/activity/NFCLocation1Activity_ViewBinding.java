...
public class NFCLocation1Activity_ViewBinding implements Unbinder {
    ...
    public NFCLocation1Activity_ViewBinding(final NFCLocation1Activity nFCLocation1Activity, View view) {
        ...
        nFCLocation1Activity.imgBack = (ImageView) Utils.castView(viewFindRequiredView, C0498R.id.imgBack, "field 'imgBack'", ImageView.class);
        ...
        nFCLocation1Activity.recyclerView = (ListView) Utils.findRequiredViewAsType(view, C0498R.id.recyclerView, "field 'recyclerView'", ListView.class);
    }
