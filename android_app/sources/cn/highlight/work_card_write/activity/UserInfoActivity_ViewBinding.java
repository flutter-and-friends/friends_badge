...
public class UserInfoActivity_ViewBinding implements Unbinder {
    ...
    public UserInfoActivity_ViewBinding(final UserInfoActivity userInfoActivity, View view) {
        ...
        userInfoActivity.imgBack = (ImageView) Utils.castView(viewFindRequiredView, C0498R.id.imgBack, "field 'imgBack'", ImageView.class);
        ...
        userInfoActivity.tvUserName = (TextView) Utils.findRequiredViewAsType(view, C0498R.id.tv_userName, "field 'tvUserName'", TextView.class);
        userInfoActivity.linearZh = (LinearLayout) Utils.findRequiredViewAsType(view, C0498R.id.linearZh, "field 'linearZh'", LinearLayout.class);
        View viewFindRequiredView2 = Utils.findRequiredView(view, C0498R.id.tv_login_out, "field 'tvLoginOut' and method 'onViewClicked'");
        userInfoActivity.tvLoginOut = (TextView) Utils.castView(viewFindRequiredView2, C0498R.id.tv_login_out, "field 'tvLoginOut'", TextView.class);
