...
public class InstructionActivity_ViewBinding implements Unbinder {
    ...
    public InstructionActivity_ViewBinding(final InstructionActivity instructionActivity, View view) {
        ...
        instructionActivity.tvTitle = (TextView) Utils.findRequiredViewAsType(view, C0498R.id.tvTitle, "field 'tvTitle'", TextView.class);
        View viewFindRequiredView = Utils.findRequiredView(view, C0498R.id.imgBack, "field 'imgBack' and method 'onViewClicked'");
        instructionActivity.imgBack = (ImageView) Utils.castView(viewFindRequiredView, C0498R.id.imgBack, "field 'imgBack'", ImageView.class);
        ...
        instructionActivity.recyclerView = (ListView) Utils.findRequiredViewAsType(view, C0498R.id.recyclerView, "field 'recyclerView'", ListView.class);
    }
