...
public class DoodleQRCode extends DoodleRotatableItemBase {
    private int bgColor;
    private int fgColor;
    ...
    public DoodleQRCode(IDoodle iDoodle, Bitmap bitmap, String str, int i, int i2, float f, float f2, float f3) {
        super(iDoodle, -iDoodle.getDoodleRotation(), f2, f3);
        this.mRect = new Rect();
        this.mSrcRect = new Rect();
        this.mDstRect = new Rect();
        setPen(DoodlePen.QRCODE);
        setPivotX(f2);
        setPivotY(f3);
        this.mBitmap = bitmap;
        this.mText = str;
