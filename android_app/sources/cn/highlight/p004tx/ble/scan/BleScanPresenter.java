...
public abstract class BleScanPresenter implements BluetoothAdapter.LeScanCallback {
    ...
    */
    private void checkDevice(cn.highlight.p004tx.ble.data.BleDevice r9) {
        /*
            r8 = this;
        ...
        L63:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: cn.highlight.p004tx.ble.scan.BleScanPresenter.checkDevice(cn.highlight.tx.ble.data.BleDevice):void");
    }
