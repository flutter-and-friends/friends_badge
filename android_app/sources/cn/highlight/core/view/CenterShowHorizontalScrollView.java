...
public class CenterShowHorizontalScrollView extends HorizontalScrollView {
    ...
    public void onClicked(View view) {
        if (view.getTag(C0450R.id.item_position) != null) {
            View childAt = this.mShowLinear.getChildAt(((Integer) view.getTag(C0450R.id.item_position)).intValue());
    ...
    public void addItemView(View view, int i) {
        view.setTag(C0450R.id.item_position, Integer.valueOf(i));
