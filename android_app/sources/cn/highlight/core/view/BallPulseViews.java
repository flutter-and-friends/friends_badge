...
public class BallPulseViews extends View implements IBottomView {
    ...
    public BallPulseViews(Context context) {
        this(context, null);
    }

    public BallPulseViews(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public BallPulseViews(Context context, AttributeSet attributeSet, int i) {
    ...
    private void createAnimators() {
        ...
        for (final int i = 0; i < 3; i++) {
            ...
            this.mUpdateListeners.put(valueAnimatorOfFloat, new ValueAnimator.AnimatorUpdateListener() { // from class: cn.highlight.core.view.BallPulseViews.1
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public void onAnimationUpdate(ValueAnimator valueAnimator) {
                    BallPulseViews.this.scaleFloats[i] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                    BallPulseViews.this.postInvalidate();
                }
            });
