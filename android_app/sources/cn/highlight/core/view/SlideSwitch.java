...
public class SlideSwitch extends View {
    ...
    public SlideSwitch(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0450R.styleable.slideswitch);
        this.color_theme = typedArrayObtainStyledAttributes.getColor(C0450R.styleable.slideswitch_themeColor, COLOR_THEME);
        this.isOpen = typedArrayObtainStyledAttributes.getBoolean(C0450R.styleable.slideswitch_isOpen, false);
        this.shape = typedArrayObtainStyledAttributes.getInt(C0450R.styleable.slideswitch_shape, 1);
