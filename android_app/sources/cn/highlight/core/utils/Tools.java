...
public class Tools {
    ...
    public static boolean isValidUrl(String str) {
        ...
        if ((!strTrim.contains("http://") && !strTrim.contains("https://")) || strTrim.contains("：") || strTrim.contains(" ") || strTrim.contains("..") || strTrim.contains("::") || strTrim.contains("///")) {
            return false;
        }
        return isValidHttpIpPort(strTrim);
    }

    public static boolean isValidHttpIpPort(String str) throws NumberFormatException {
        int i;
        if (!str.startsWith("http://") && !str.startsWith("https://")) {
            return false;
        }
        String strSubstring = str.substring(str.indexOf("://") + 3);
        String[] strArrSplit = strSubstring.substring(0, strSubstring.indexOf("/")).split(":", 2);
    ...
    private static boolean isValidIpV4(String str) throws NumberFormatException {
    ...
    public static void startAnimation(final View view, ImageView imageView, int i, int i2, boolean z) {
        ...
        animationSet.setAnimationListener(new Animation.AnimationListener() { // from class: cn.highlight.core.utils.Tools.1
