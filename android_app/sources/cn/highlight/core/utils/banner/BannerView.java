...
public class BannerView extends LinearLayout {
    ...
    public BannerView(Context context, AttributeSet attributeSet) {
        ...
        LayoutInflater.from(context).inflate(C0450R.layout.banner_view, this);
        this.mAdvPager = (ViewPager) findViewById(C0450R.id.adv_pager);
        ...
        this.mGroup = (ViewGroup) findViewById(C0450R.id.viewGroup);
    }
    ...
    public void setImageResources(List<BannerBean> list, ImageCycleViewListener imageCycleViewListener) throws Resources.NotFoundException {
        ...
        for (int i = 0; i < this.size; i++) {
            ...
            if (i == 0) {
                imageViewArr[i].setBackgroundResource(C0450R.drawable.dot_b);
            } else {
                imageViewArr[i].setBackgroundResource(C0450R.drawable.dot_h);
            }
    ...
    private final class GuidePageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int i) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                if (i % length != i2) {
                    BannerView.this.mImageViews[i2 % length].setBackgroundResource(C0450R.drawable.dot_b);
                } else {
                    BannerView.this.mImageViews[i2 % length].setBackgroundResource(C0450R.drawable.dot_h);
                }
            }
        }
    }
    ...
    private class ImageCycleAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup viewGroup, final int i) {
            ...
            imageViewRemove.setTag(C0450R.id.img_url_banner, imgUrl);
