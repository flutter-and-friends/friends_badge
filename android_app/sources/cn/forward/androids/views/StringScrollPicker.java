...
public class StringScrollPicker extends ScrollPickerView<CharSequence> {
    ...
    private void init(AttributeSet attributeSet) {
        if (attributeSet != null) {
            TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C0428R.styleable.StringScrollPicker);
            this.mMinTextSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(C0428R.styleable.StringScrollPicker_spv_min_text_size, this.mMinTextSize);
            this.mMaxTextSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(C0428R.styleable.StringScrollPicker_spv_max_text_size, this.mMaxTextSize);
            this.mStartColor = typedArrayObtainStyledAttributes.getColor(C0428R.styleable.StringScrollPicker_spv_start_color, this.mStartColor);
            this.mEndColor = typedArrayObtainStyledAttributes.getColor(C0428R.styleable.StringScrollPicker_spv_end_color, this.mEndColor);
            this.mMaxLineWidth = typedArrayObtainStyledAttributes.getDimensionPixelSize(C0428R.styleable.StringScrollPicker_spv_max_line_width, this.mMaxLineWidth);
            int i = typedArrayObtainStyledAttributes.getInt(C0428R.styleable.StringScrollPicker_spv_alignment, 1);
            if (i == 2) {
