...
public class MaskImageView extends PaddingImageView {
    ...
    private void init(AttributeSet attributeSet) {
        TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C0428R.styleable.MaskImageView);
        this.mIsIgnoreAlpha = typedArrayObtainStyledAttributes.getBoolean(C0428R.styleable.MaskImageView_miv_is_ignore_alpha, this.mIsIgnoreAlpha);
        this.mIsShowMaskOnClick = typedArrayObtainStyledAttributes.getBoolean(C0428R.styleable.MaskImageView_miv_is_show_mask_on_click, this.mIsShowMaskOnClick);
        this.mMaskColor = typedArrayObtainStyledAttributes.getColor(C0428R.styleable.MaskImageView_miv_mask_color, this.mMaskColor);
        this.mMaskLevel = typedArrayObtainStyledAttributes.getInt(C0428R.styleable.MaskImageView_miv_mask_level, this.mMaskLevel);
        this.mPressedAlpha = typedArrayObtainStyledAttributes.getFloat(C0428R.styleable.MaskImageView_miv_pressed_alpha, this.mPressedAlpha);
