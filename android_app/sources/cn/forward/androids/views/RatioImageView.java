...
public class RatioImageView extends ImageView {
    ...
    private void init(AttributeSet attributeSet) {
        TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C0428R.styleable.RatioImageView);
        this.mIsWidthFitDrawableSizeRatio = typedArrayObtainStyledAttributes.getBoolean(C0428R.styleable.RatioImageView_riv_is_width_fix_drawable_size_ratio, this.mIsWidthFitDrawableSizeRatio);
        this.mIsHeightFitDrawableSizeRatio = typedArrayObtainStyledAttributes.getBoolean(C0428R.styleable.RatioImageView_riv_is_height_fix_drawable_size_ratio, this.mIsHeightFitDrawableSizeRatio);
        this.mMaxWidthWhenWidthFixDrawable = typedArrayObtainStyledAttributes.getDimensionPixelOffset(C0428R.styleable.RatioImageView_riv_max_width_when_width_fix_drawable, this.mMaxWidthWhenWidthFixDrawable);
        this.mMaxHeightWhenHeightFixDrawable = typedArrayObtainStyledAttributes.getDimensionPixelOffset(C0428R.styleable.RatioImageView_riv_max_height_when_height_fix_drawable, this.mMaxHeightWhenHeightFixDrawable);
        this.mHeightRatio = typedArrayObtainStyledAttributes.getFloat(C0428R.styleable.RatioImageView_riv_height_to_width_ratio, this.mHeightRatio);
        this.mWidthRatio = typedArrayObtainStyledAttributes.getFloat(C0428R.styleable.RatioImageView_riv_width_to_height_ratio, this.mWidthRatio);
        this.mDesiredWidth = typedArrayObtainStyledAttributes.getDimensionPixelOffset(C0428R.styleable.RatioImageView_riv_width, this.mDesiredWidth);
        this.mDesiredHeight = typedArrayObtainStyledAttributes.getDimensionPixelOffset(C0428R.styleable.RatioImageView_riv_height, this.mDesiredHeight);
