...
public class ComparisonsKt__ComparisonsKt {
    ...
    /* compiled from: Comparisons.kt */
    @Metadata(m847bv = {1, 0, 3}, m848d1 = {"\u0000\n\n\u0000\n\u0002\u0010\b\n\u0002\b\u0006\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u000e\u0010\u0003\u001a\n \u0004*\u0004\u0018\u0001H\u0002H\u00022\u000e\u0010\u0005\u001a\n \u0004*\u0004\u0018\u0001H\u0002H\u0002H\n¢\u0006\u0004\b\u0006\u0010\u0007"}, m849d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "a", "kotlin.jvm.PlatformType", "b", "compare", "(Ljava/lang/Object;Ljava/lang/Object;)I"}, m850k = 3, m851mv = {1, 1, 16})
    /* renamed from: kotlin.comparisons.ComparisonsKt__ComparisonsKt$compareBy$2 */
    public static final class C15512<T> implements Comparator<T> {
        final /* synthetic */ Function1 $selector;

        public C15512(Function1 function1) {
    ...
    public static final class C15531<T> implements Comparator<T> {
        final /* synthetic */ Function1 $selector;

        public C15531(Function1 function1) {
            this.$selector = function1;
        }
    ...
    private static final <T> Comparator<T> thenBy(final Comparator<T> comparator, final Function1<? super T, ? extends Comparable<?>> function1) {
        return new Comparator<T>() { // from class: kotlin.comparisons.ComparisonsKt__ComparisonsKt.thenBy.1
            ...
            public final int compare(T t, T t2) {
                ...
                return iCompare != 0 ? iCompare : ComparisonsKt.compareValues((Comparable) function1.invoke(t), (Comparable) function1.invoke(t2));
            }
        };
    }
    ...
    private static final <T> Comparator<T> thenByDescending(final Comparator<T> comparator, final Function1<? super T, ? extends Comparable<?>> function1) {
        return new Comparator<T>() { // from class: kotlin.comparisons.ComparisonsKt__ComparisonsKt.thenByDescending.1
            ...
            public final int compare(T t, T t2) {
                int iCompare = comparator.compare(t, t2);
                return iCompare != 0 ? iCompare : ComparisonsKt.compareValues((Comparable) function1.invoke(t2), (Comparable) function1.invoke(t));
            }
        };
    }
    ...
    private static final <T> Comparator<T> thenComparator(final Comparator<T> comparator, final Function2<? super T, ? super T, Integer> function2) {
        return new Comparator<T>() { // from class: kotlin.comparisons.ComparisonsKt__ComparisonsKt.thenComparator.1
            ...
            public final int compare(T t, T t2) {
                int iCompare = comparator.compare(t, t2);
                return iCompare != 0 ? iCompare : ((Number) function2.invoke(t, t2)).intValue();
            }
        };
    }
