...
public final class ConsoleKt {
    ...
    public static final String readLine(InputStream inputStream, CharsetDecoder decoder) throws IOException {
        ...
        if (iPosition > 0 && charBuffer.get(iPosition - 1) == '\n' && iPosition - 1 > 0 && charBuffer.get(iPosition - 1) == '\r') {
            iPosition--;
        }
        charBuffer.flip();
    ...
    private static final boolean tryDecode(CharsetDecoder charsetDecoder, ByteBuffer byteBuffer, CharBuffer charBuffer, boolean z) throws CharacterCodingException {
        int iPosition = charBuffer.position();
        byteBuffer.flip();
