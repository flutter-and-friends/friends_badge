...
class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    /* renamed from: ln */
    private static final double m867ln(double d) {
        return Math.log(d);
    }
    ...
    /* renamed from: ln */
    private static final float m868ln(float f) {
