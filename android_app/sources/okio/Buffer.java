    ...
    */
    ...
    public Buffer writeUtf8(String str, int i, int i2) {
        ...
        while (i < i2) {
            ...
            if (cCharAt < 128) {
                ...
                if (cCharAt < 2048) {
                    writeByte((cCharAt >> 6) | FtdiSerialDriver.FtdiSerialPort.FTDI_DEVICE_IN_REQTYPE);
                    ...
                    if (cCharAt > 56319 || cCharAt3 < 56320 || cCharAt3 > 57343) {
                        ...
                        writeByte((i7 >> 18) | EnumG.BaseMid_SafeCertification);
    ...
    public Buffer writeUtf8CodePoint(int i) {
        if (i < 128) {
            ...
            writeByte((i >> 6) | FtdiSerialDriver.FtdiSerialPort.FTDI_DEVICE_IN_REQTYPE);
            writeByte((i & 63) | 128);
        } else if (i < 65536) {
            if (i >= 55296 && i <= 57343) {
                writeByte(63);
            ...
            writeByte((i >> 18) | EnumG.BaseMid_SafeCertification);
    ...
    public long indexOf(byte b, long j, long j2) {
        ...
        while (j5 < j4) {
            ...
            for (int i = (int) ((segment.pos + j6) - j5); i < iMin; i++) {
                if (bArr[i] == b) {
    ...
    private ByteString digest(String str) throws NoSuchAlgorithmException {
        try {
            ...
            return ByteString.m873of(messageDigest.digest());
    ...
    private ByteString hmac(String str, ByteString byteString) throws IllegalStateException, NoSuchAlgorithmException, InvalidKeyException {
        try {
            ...
            return ByteString.m873of(mac.doFinal());
