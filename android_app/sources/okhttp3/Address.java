...
public final class Address {
    ...
    public int hashCode() {
        int iHashCode = (((((((((((PropertyID.M25_LENGTH2 + this.url.hashCode()) * 31) + this.dns.hashCode()) * 31) + this.proxyAuthenticator.hashCode()) * 31) + this.protocols.hashCode()) * 31) + this.connectionSpecs.hashCode()) * 31) + this.proxySelector.hashCode()) * 31;
