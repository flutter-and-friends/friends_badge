...
public class Write {
    ...
    public void write() throws WriteException, IOException {
        ...
        WritableSheet writableSheetCreateSheet = this.workbook.createSheet("Number Formats", 0);
        WritableSheet writableSheetCreateSheet2 = this.workbook.createSheet("Date Formats", 1);
        WritableSheet writableSheetCreateSheet3 = this.workbook.createSheet("Label Formats", 2);
        WritableSheet writableSheetCreateSheet4 = this.workbook.createSheet("Borders", 3);
        WritableSheet writableSheetCreateSheet5 = this.workbook.createSheet("Labels", 4);
        WritableSheet writableSheetCreateSheet6 = this.workbook.createSheet("Formulas", 5);
        WritableSheet writableSheetCreateSheet7 = this.workbook.createSheet("Images", 6);
        this.workbook.setColourRGB(Colour.LIME, 255, 0, 0);
        this.workbook.addNameArea("namedrange", writableSheetCreateSheet4, 1, 11, 5, 14);
        this.workbook.addNameArea("validation_range", writableSheetCreateSheet3, 4, 65, 9, 65);
        writableSheetCreateSheet5.getSettings().setPrintArea(4, 4, 15, 35);
        writeLabelFormatSheet(writableSheetCreateSheet3);
        writeNumberFormatSheet(writableSheetCreateSheet);
        writeDateFormatSheet(writableSheetCreateSheet2);
        writeBordersSheet(writableSheetCreateSheet4);
        writeLabelsSheet(writableSheetCreateSheet5);
        writeFormulaSheet(writableSheetCreateSheet6);
        writeImageSheet(writableSheetCreateSheet7);
        this.workbook.write();
        this.workbook.close();
    }
    ...
    private void writeDateFormatSheet(WritableSheet writableSheet) throws WriteException {
        ...
        calendar.set(LunarCalendar.MIN_YEAR, 0, 1, 0, 0, 0);
        calendar.set(14, 0);
        ...
        calendar.set(LunarCalendar.MIN_YEAR, 0, 2, 0, 0, 0);
        Date time5 = calendar.getTime();
        calendar.set(1901, 0, 1, 0, 0, 0);
        Date time6 = calendar.getTime();
        calendar.set(LunarCalendar.MIN_YEAR, 4, 31, 0, 0, 0);
        Date time7 = calendar.getTime();
        calendar.set(LunarCalendar.MIN_YEAR, 1, 1, 0, 0, 0);
        Date time8 = calendar.getTime();
        calendar.set(LunarCalendar.MIN_YEAR, 0, 31, 0, 0, 0);
        Date time9 = calendar.getTime();
        calendar.set(LunarCalendar.MIN_YEAR, 2, 1, 0, 0, 0);
        Date time10 = calendar.getTime();
        calendar.set(LunarCalendar.MIN_YEAR, 1, 27, 0, 0, 0);
        Date time11 = calendar.getTime();
        calendar.set(LunarCalendar.MIN_YEAR, 1, 28, 0, 0, 0);
    ...
    private void writeLabelFormatSheet(WritableSheet writableSheet) throws WriteException {
        ...
        try {
            ...
            Range rangeMergeCells = writableSheet.mergeCells(5, 38, i2, 41);
            writableSheet.insertRow(40);
            writableSheet.removeRow(39);
            writableSheet.unmergeCells(rangeMergeCells);
        ...
        writableSheet.addCell(new Label(5, 38, "More merged cells"));
        Range rangeMergeCells2 = writableSheet.mergeCells(5, 38, i2, 41);
        writableSheet.insertRow(40);
        writableSheet.removeRow(39);
        writableSheet.unmergeCells(rangeMergeCells2);
    ...
    private void writeBordersSheet(WritableSheet writableSheet) throws WriteException {
        ...
        writableSheet.getSettings().setPaperSize(PaperSize.f1150A3);
