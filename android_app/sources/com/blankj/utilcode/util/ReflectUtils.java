...
public final class ReflectUtils {
    ...
    public ReflectUtils field(String str) throws NoSuchFieldException, IllegalArgumentException {
        try {
    ...
    private Field getField(String str) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
    ...
    private <T extends AccessibleObject> T accessible(T t) throws SecurityException {
        if (t == null) {
            return null;
        }
