...
class StrictLineReader implements Closeable {
    ...
    /* renamed from: CR */
    private static final byte f318CR = 13;

    /* renamed from: LF */
    private static final byte f319LF = 10;
    private byte[] buf;
    private final Charset charset;
    private int end;

    /* renamed from: in */
    private final InputStream f320in;
    private int pos;
    ...
    */
    public java.lang.String readLine() throws java.io.IOException {
        /*
            r7 = this;
            java.io.InputStream r0 = r7.f320in
            monitor-enter(r0)
    ...
    private void fillBuf() throws IOException {
        InputStream inputStream = this.f320in;
        byte[] bArr = this.buf;
