...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f323ix = readShort();
        this.header.currentFrame.f324iy = readShort();
        this.header.currentFrame.f322iw = readShort();
        this.header.currentFrame.f321ih = readShort();
        int i = read();
        boolean z = (i & 128) != 0;
