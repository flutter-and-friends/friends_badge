...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{PropertyID.M25_ENABLE}, "GR");
            add(new int[]{PropertyID.I25_ENABLE}, ExpandedProductParsedResult.POUND);
            add(new int[]{529}, "CY");
            add(new int[]{PropertyID.I25_SEND_CHECK}, "MK");
            add(new int[]{535}, "MT");
            add(new int[]{539}, "IE");
            add(new int[]{540, PropertyID.CODE11_LENGTH2}, "BE/LU");
            add(new int[]{560}, "PT");
            add(new int[]{569}, "IS");
            ...
            add(new int[]{770}, "CO");
            add(new int[]{PropertyID.CODABAR_NOTIS}, "UY");
            add(new int[]{775}, "PE");
            add(new int[]{777}, "BO");
            add(new int[]{779}, "AR");
            add(new int[]{780}, "CL");
