...
final class DecodedBitStreamParser {
    ...
    static DecoderResult decode(byte[] bArr, int i) {
        ...
        if (i == 2 || i == 3) {
            ...
            if (sb.toString().startsWith("[)>\u001e01\u001d")) {
                sb.insert(9, String.valueOf(postCode3) + f381GS + str + f381GS + str2 + f381GS);
            } else {
                sb.insert(0, String.valueOf(postCode3) + f381GS + str + f381GS + str2 + f381GS);
            }
        } else if (i == 4) {
    ...
    private static int getPostCode2(byte[] bArr) {
        return getInt(bArr, new byte[]{33, 34, 35, 36, 25, 26, 27, 28, 29, 30, 19, 20, 21, 22, 23, 24, 13, 14, 15, CmdCenter.CMD_openMoreCabinet, CmdCenter.CMD_getCabinetLockStatus, CmdCenter.CMD_setCabinetSensor, 7, 8, 9, 10, 11, 12, 1, 2});
    }

    private static String getPostCode3(byte[] bArr) {
        return String.valueOf(new char[]{SETS[0].charAt(getInt(bArr, new byte[]{39, 40, 41, 42, 31, 32})), SETS[0].charAt(getInt(bArr, new byte[]{33, 34, 35, 36, 25, 26})), SETS[0].charAt(getInt(bArr, new byte[]{27, 28, 29, 30, 19, 20})), SETS[0].charAt(getInt(bArr, new byte[]{21, 22, 23, 24, 13, 14})), SETS[0].charAt(getInt(bArr, new byte[]{15, CmdCenter.CMD_openMoreCabinet, CmdCenter.CMD_getCabinetLockStatus, CmdCenter.CMD_setCabinetSensor, 7, 8})), SETS[0].charAt(getInt(bArr, new byte[]{9, 10, 11, 12, 1, 2}))});
    }
        ...
        while (i3 < i + i2) {
            ...
            switch (cCharAt) {
                ...
                case 65531:
                    ...
                    int i8 = bArr[i7] << 24;
                    int i9 = i7 + 1;
                    int i10 = i8 + (bArr[i9] << CmdCenter.CMD_setCabinetSensor);
                    int i11 = i9 + 1;
