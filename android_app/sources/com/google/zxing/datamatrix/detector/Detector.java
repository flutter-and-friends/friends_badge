...
public final class Detector {
    ...
    public DetectorResult detect() throws NotFoundException {
        ...
        if (i * 4 >= i2 * 7 || i2 * 4 >= i * 7) {
            resultPoint2 = r6;
            resultPointCorrectTopRightRectangular = correctTopRightRectangular(r22, r14, r6, resultPoint, i, i2);
            ...
            int transitions4 = transitionsBetween(r14, resultPointCorrectTopRightRectangular).getTransitions();
            if ((transitions3 & 1) == 1) {
                transitions3++;
            }
            int i3 = transitions3;
            ...
            bitMatrixSampleGrid = sampleGrid(this.image, resultPoint2, r22, r14, resultPointCorrectTopRightRectangular, i3, transitions4);
        } else {
            resultPointCorrectTopRightRectangular = correctTopRight(r22, r14, r6, resultPoint, Math.min(i2, i));
            if (resultPointCorrectTopRightRectangular == null) {
                resultPointCorrectTopRightRectangular = resultPoint;
            }
            int iMax = Math.max(transitionsBetween(r6, resultPointCorrectTopRightRectangular).getTransitions(), transitionsBetween(r14, resultPointCorrectTopRightRectangular).getTransitions()) + 1;
            if ((iMax & 1) == 1) {
                iMax++;
            }
            int i4 = iMax;
            bitMatrixSampleGrid = sampleGrid(this.image, r6, r22, r14, resultPointCorrectTopRightRectangular, i4, i4);
            resultPoint2 = r6;
        }
        return new DetectorResult(bitMatrixSampleGrid, new ResultPoint[]{resultPoint2, r22, r14, resultPointCorrectTopRightRectangular});
    }
    ...
    private static final class ResultPointsAndTransitions {
        ...
        /* renamed from: to */
        private final ResultPoint f379to;
        private final int transitions;

        private ResultPointsAndTransitions(ResultPoint resultPoint, ResultPoint resultPoint2, int i) {
            this.from = resultPoint;
            this.f379to = resultPoint2;
            this.transitions = i;
        }
        ...
        public String toString() {
            return this.from + "/" + this.f379to + '/' + this.transitions;
        }
    }
