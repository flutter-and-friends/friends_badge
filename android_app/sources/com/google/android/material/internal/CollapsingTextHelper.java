...
public final class CollapsingTextHelper {
    ...
    public void setCollapsedTextAppearance(int i) {
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(this.view.getContext(), i, C0036R.styleable.TextAppearance);
        if (tintTypedArrayObtainStyledAttributes.hasValue(C0036R.styleable.TextAppearance_android_textColor)) {
            this.collapsedTextColor = tintTypedArrayObtainStyledAttributes.getColorStateList(C0036R.styleable.TextAppearance_android_textColor);
        }
        if (tintTypedArrayObtainStyledAttributes.hasValue(C0036R.styleable.TextAppearance_android_textSize)) {
            this.collapsedTextSize = tintTypedArrayObtainStyledAttributes.getDimensionPixelSize(C0036R.styleable.TextAppearance_android_textSize, (int) this.collapsedTextSize);
        }
        this.collapsedShadowColor = tintTypedArrayObtainStyledAttributes.getInt(C0036R.styleable.TextAppearance_android_shadowColor, 0);
        this.collapsedShadowDx = tintTypedArrayObtainStyledAttributes.getFloat(C0036R.styleable.TextAppearance_android_shadowDx, 0.0f);
        this.collapsedShadowDy = tintTypedArrayObtainStyledAttributes.getFloat(C0036R.styleable.TextAppearance_android_shadowDy, 0.0f);
        this.collapsedShadowRadius = tintTypedArrayObtainStyledAttributes.getFloat(C0036R.styleable.TextAppearance_android_shadowRadius, 0.0f);
    ...
    public void setExpandedTextAppearance(int i) {
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(this.view.getContext(), i, C0036R.styleable.TextAppearance);
        if (tintTypedArrayObtainStyledAttributes.hasValue(C0036R.styleable.TextAppearance_android_textColor)) {
            this.expandedTextColor = tintTypedArrayObtainStyledAttributes.getColorStateList(C0036R.styleable.TextAppearance_android_textColor);
        }
        if (tintTypedArrayObtainStyledAttributes.hasValue(C0036R.styleable.TextAppearance_android_textSize)) {
            this.expandedTextSize = tintTypedArrayObtainStyledAttributes.getDimensionPixelSize(C0036R.styleable.TextAppearance_android_textSize, (int) this.expandedTextSize);
        }
        this.expandedShadowColor = tintTypedArrayObtainStyledAttributes.getInt(C0036R.styleable.TextAppearance_android_shadowColor, 0);
        this.expandedShadowDx = tintTypedArrayObtainStyledAttributes.getFloat(C0036R.styleable.TextAppearance_android_shadowDx, 0.0f);
        this.expandedShadowDy = tintTypedArrayObtainStyledAttributes.getFloat(C0036R.styleable.TextAppearance_android_shadowDy, 0.0f);
        this.expandedShadowRadius = tintTypedArrayObtainStyledAttributes.getFloat(C0036R.styleable.TextAppearance_android_shadowRadius, 0.0f);
        tintTypedArrayObtainStyledAttributes.recycle();
        if (Build.VERSION.SDK_INT >= 16) {
