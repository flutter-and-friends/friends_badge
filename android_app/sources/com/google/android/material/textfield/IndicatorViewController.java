...
final class IndicatorViewController {
    ...
    public IndicatorViewController(TextInputLayout textInputLayout) {
        ...
        this.captionTranslationYPx = this.context.getResources().getDimensionPixelSize(C1049R.dimen.design_textinput_caption_translate_y);
    }
    ...
    void setErrorEnabled(boolean z) {
        ...
        if (z) {
            ...
            this.errorView.setId(C1049R.id.textinput_error);
    ...
    void setHelperTextEnabled(boolean z) {
        ...
        if (z) {
            ...
            this.helperTextView.setId(C1049R.id.textinput_helper_text);
            Typeface typeface = this.typeface;
            if (typeface != null) {
