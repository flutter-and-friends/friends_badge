...
public class SnackbarContentLayout extends LinearLayout implements ContentViewCallback {
    ...
    public SnackbarContentLayout(Context context, AttributeSet attributeSet) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1049R.styleable.SnackbarLayout);
        this.maxWidth = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1049R.styleable.SnackbarLayout_android_maxWidth, -1);
        this.maxInlineActionWidth = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1049R.styleable.SnackbarLayout_maxActionInlineWidth, -1);
    ...
    protected void onFinishInflate() {
        ...
        this.messageView = (TextView) findViewById(C1049R.id.snackbar_text);
        this.actionView = (Button) findViewById(C1049R.id.snackbar_action);
    }
    ...
    */
    protected void onMeasure(int r8, int r9) throws android.content.res.Resources.NotFoundException {
        ...
        L18:
            ...
            int r1 = com.google.android.material.C1049R.dimen.design_snackbar_padding_vertical_2lines
            int r0 = r0.getDimensionPixelSize(r1)
            android.content.res.Resources r1 = r7.getResources()
            int r2 = com.google.android.material.C1049R.dimen.design_snackbar_padding_vertical
