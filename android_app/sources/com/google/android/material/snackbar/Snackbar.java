...
public final class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    private static final int[] SNACKBAR_BUTTON_STYLE_ATTR = {C1049R.attr.snackbarButtonStyle};
    ...
    public static Snackbar make(View view, CharSequence charSequence, int i) {
        ...
        SnackbarContentLayout snackbarContentLayout = (SnackbarContentLayout) LayoutInflater.from(viewGroupFindSuitableParent.getContext()).inflate(hasSnackbarButtonStyleAttr(viewGroupFindSuitableParent.getContext()) ? C1049R.layout.mtrl_layout_snackbar_include : C1049R.layout.design_layout_snackbar_include, viewGroupFindSuitableParent, false);
