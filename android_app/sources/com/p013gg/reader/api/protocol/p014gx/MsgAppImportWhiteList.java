...
public class MsgAppImportWhiteList extends Message {
    ...
    public MsgAppImportWhiteList(byte[] bArr) {
        this();
        if (bArr != null) {
            try {
                if (bArr.length <= 0) {
    ...
    public void ackUnpack() {
        Hashtable<Byte, String> hashtable = new Hashtable<Byte, String>() { // from class: com.gg.reader.api.protocol.gx.MsgAppImportWhiteList.1
            {
                put((byte) 0, "Success.");
                put((byte) 1, "Fail.");
            }
