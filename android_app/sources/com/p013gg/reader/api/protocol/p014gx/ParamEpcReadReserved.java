...
public class ParamEpcReadReserved extends Parameter {
    private int len;
    private int start;

    public ParamEpcReadReserved() {
    }

    public ParamEpcReadReserved(int i, int i2) {
        this.start = i;
        this.len = i2;
    }
    ...
    public ParamEpcReadReserved(byte[] bArr) {
