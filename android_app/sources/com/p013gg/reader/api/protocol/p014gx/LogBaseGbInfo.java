...
public class LogBaseGbInfo extends Message {
    private int antId;
    private byte[] bEpc;
    private byte[] bTid;
    private byte[] bUser;
    ...
    public void ackUnpack() {
        ...
        this.f353pc = bitBufferWrap.getIntUnsigned(16);
    ...
    public String toString() {
        return "LogBaseGbInfo{epc='" + this.epc + "', bEpc=" + Arrays.toString(this.bEpc) + ", tid='" + this.tid + "', bTid=" + Arrays.toString(this.bTid) + ", pc=" + this.f353pc + ", antId=" + this.antId + ", rssi=" + this.rssi + ", result=" + this.result + ", userdata='" + this.userdata + "', bUser=" + Arrays.toString(this.bUser) + ", readerSerialNumber='" + this.readerSerialNumber + "'}";
    }
