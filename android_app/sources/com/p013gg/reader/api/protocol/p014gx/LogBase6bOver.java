...
public class LogBase6bOver extends Message {
    ...
    public void ackUnpack() {
        ...
        Hashtable<Byte, String> hashtable = new Hashtable<Byte, String>() { // from class: com.gg.reader.api.protocol.gx.LogBase6bOver.1
            {
    ...
    public String toString() {
        return "LogBase6bOver{readerSerialNumber='" + this.readerSerialNumber + "'}";
    }
}
