...
public class MsgBaseLockGJb extends Message {
    ...
    public MsgBaseLockGJb() {
        this.safeCertificationFlag = Integer.MAX_VALUE;
        try {
            this.msgType = new MsgType();
            this.msgType.mt_8_11 = EnumG.MSG_TYPE_BIT_BASE;
            this.msgType.msgId = (byte) 98;
            this.dataLen = 0;
        } catch (Exception unused) {
        }
    }

    public MsgBaseLockGJb(byte[] bArr) {
        this();
        if (bArr != null) {
            try {
                if (bArr.length <= 0) {
    ...
    public void ackUnpack() {
        Hashtable<Byte, String> hashtable = new Hashtable<Byte, String>() { // from class: com.gg.reader.api.protocol.gx.MsgBaseLockGJb.1
            {
                put((byte) 0, "Success.");
