...
public class LogAppGpiStart extends Message {
    private int gpiPort;
    ...
    public String toString() {
        return "LogAppGpiStart{gpiPort=" + this.gpiPort + ", gpiPortLevel=" + this.gpiPortLevel + ", systemTime=" + this.systemTime + ", readerSerialNumber='" + this.readerSerialNumber + "'}";
    }
}
