...
public class MsgBaseWriteGJb extends Message {
    ...
    public void pack() {
        ...
        if (Integer.MAX_VALUE != this.safeCertificationFlag) {
            ...
            bitBufferAllocateDynamic.putInt(this.safeCertificationFlag, 8);
        }
    ...
    public void ackUnpack() {
        Hashtable<Byte, String> hashtable = new Hashtable<Byte, String>() { // from class: com.gg.reader.api.protocol.gx.MsgBaseWriteGJb.1
            {
                put((byte) 0, "Success.");
