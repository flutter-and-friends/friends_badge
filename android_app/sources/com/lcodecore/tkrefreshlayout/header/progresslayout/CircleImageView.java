...
public class CircleImageView extends ImageView {
    ...
    private class OvalShadow extends OvalShape {
        ...
        public OvalShadow(int i, int i2) {
            ...
            this.mRadialGradient = new RadialGradient(i3 / 2, i3 / 2, CircleImageView.this.mShadowRadius, new int[]{CircleImageView.FILL_SHADOW_COLOR, 0}, (float[]) null, Shader.TileMode.CLAMP);
