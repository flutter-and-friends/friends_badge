...
class ResourcesFlusher {
    ...
    static void flush(Resources resources) throws IllegalAccessException, IllegalArgumentException {
    ...
    private static void flushMarshmallows(Resources resources) throws IllegalAccessException, IllegalArgumentException {
        if (!sDrawableCacheFieldFetched) {
            try {
                sDrawableCacheField = Resources.class.getDeclaredField("mDrawableCache");
                sDrawableCacheField.setAccessible(true);
    ...
    private static void flushNougats(Resources resources) throws IllegalAccessException, IllegalArgumentException {
        Object obj;
