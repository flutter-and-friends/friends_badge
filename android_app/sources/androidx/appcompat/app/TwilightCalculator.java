...
class TwilightCalculator {
    ...
    /* renamed from: C1 */
    private static final float f9C1 = 0.0334196f;

    /* renamed from: C2 */
    private static final float f10C2 = 3.49066E-4f;

    /* renamed from: C3 */
    private static final float f11C3 = 5.236E-6f;
    public static final int DAY = 0;
    private static final float DEGREES_TO_RADIANS = 0.017453292f;

    /* renamed from: J0 */
    private static final float f12J0 = 9.0E-4f;
    ...
    public void calculateTwilight(long j, double d, double d2) {
        ...
        double dRound = Math.round((r3 - f12J0) - r9) + f12J0 + ((-d2) / 360.0d) + (Math.sin(d3) * 0.0053d) + (Math.sin(2.0d * dSin) * (-0.0069d));
        ...
        if (dSin2 >= 1.0d) {
            ...
            this.sunrise = Math.round((dRound - dAcos) * 8.64E7d) + UTC_2000;
