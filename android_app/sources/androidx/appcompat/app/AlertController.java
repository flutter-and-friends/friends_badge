...
class AlertController {
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        ...
        View viewFindViewById2 = this.mWindow.findViewById(C0036R.id.scrollIndicatorDown);
    ...
    private void setupTitle(ViewGroup viewGroup) {
        ...
        if ((!TextUtils.isEmpty(this.mTitle)) && this.mShowTitle) {
            this.mTitleView = (TextView) this.mWindow.findViewById(C0036R.id.alertTitle);
    ...
    private void setupContent(ViewGroup viewGroup) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0036R.id.scrollView);
        ...
        private void createListView(final AlertController alertController) {
            ...
            if (this.mIsMultiChoice) {
                ...
                if (cursor == null) {
                    ...
                    checkedItemAdapter = new CursorAdapter(this.mContext, cursor, false) { // from class: androidx.appcompat.app.AlertController.AlertParams.2
                ...
                if (cursor2 != null) {
                    checkedItemAdapter = new SimpleCursorAdapter(this.mContext, i2, cursor2, new String[]{this.mLabelColumn}, new int[]{R.id.text1});
                } else {
