...
class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    public ActionMenuPresenter(Context context) {
        super(context, C0036R.layout.abc_action_menu_layout, C0036R.layout.abc_action_menu_item_layout);
    ...
    public boolean flagActionItems() {
        ...
        if (actionMenuPresenter.mReserveOverflow && (z || i8 + i7 > i6)) {
            i6--;
        }
        int i10 = i6 - i7;
        ...
        if (actionMenuPresenter.mStrictWidthLimit) {
            ...
            iMeasureChildForCells = i5 / i11;
            i = i11 + ((i5 % i11) / iMeasureChildForCells);
        } else {
            i = 0;
        ...
        while (i13 < size) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                ...
                boolean z3 = (i10 > 0 || z2) && i12 > 0 && (!actionMenuPresenter.mStrictWidthLimit || iMeasureChildForCells > 0);
                boolean z4 = z3;
                i2 = size;
                if (z3) {
                    ...
                    z3 = z4 & (!actionMenuPresenter.mStrictWidthLimit ? i12 + i14 <= 0 : i12 < 0);
                }
                if (z3 && groupId2 != 0) {
    ...
    private class OverflowMenuButton extends AppCompatImageView implements ActionMenuView.ActionMenuChildView {
        ...
        public OverflowMenuButton(Context context) {
            super(context, null, C0036R.attr.actionOverflowButtonStyle);
            setClickable(true);
            setFocusable(true);
            setVisibility(0);
            setEnabled(true);
    ...
    private class OverflowPopup extends MenuPopupHelper {
        public OverflowPopup(Context context, MenuBuilder menuBuilder, View view, boolean z) {
            super(context, menuBuilder, view, z, C0036R.attr.actionOverflowMenuStyle);
    ...
    private class ActionButtonSubmenu extends MenuPopupHelper {
        public ActionButtonSubmenu(Context context, SubMenuBuilder subMenuBuilder, View view) {
            super(context, subMenuBuilder, view, false, C0036R.attr.actionOverflowMenuStyle);
