    ...
    */
    ...
    private void updateTypefaceAndStyle(Context context, TintTypedArray tintTypedArray) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            this.mFontWeight = tintTypedArray.getInt(C0036R.styleable.TextAppearance_android_textFontWeight, -1);
        ...
        if (tintTypedArray.hasValue(C0036R.styleable.TextAppearance_android_typeface)) {
            ...
            int i4 = tintTypedArray.getInt(C0036R.styleable.TextAppearance_android_typeface, 1);
            if (i4 == 1) {
