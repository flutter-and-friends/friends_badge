...
public final class LayoutInflaterCompat {
    ...
    private static void forceSetFactory2(LayoutInflater layoutInflater, LayoutInflater.Factory2 factory2) throws IllegalAccessException, IllegalArgumentException {
        if (!sCheckedField) {
            try {
    ...
    @Deprecated
    public static void setFactory(LayoutInflater layoutInflater, LayoutInflaterFactory layoutInflaterFactory) throws IllegalAccessException, IllegalArgumentException {
