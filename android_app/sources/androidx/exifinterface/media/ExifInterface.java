...
public class ExifInterface {
    ...
    private static final ExifTag[] IFD_TIFF_TAGS = {new ExifTag(TAG_NEW_SUBFILE_TYPE, 254, 4), new ExifTag(TAG_SUBFILE_TYPE, 255, 4), new ExifTag(TAG_IMAGE_WIDTH, 256, 3, 4), new ExifTag(TAG_IMAGE_LENGTH, 257, 3, 4), new ExifTag(TAG_BITS_PER_SAMPLE, PropertyID.CODE39_ENABLE_CHECK, 3), new ExifTag(TAG_COMPRESSION, PropertyID.CODE39_SEND_CHECK, 3), new ExifTag(TAG_PHOTOMETRIC_INTERPRETATION, PropertyID.LABEL_MATCHER_REPLACEMENT, 3), new ExifTag(TAG_IMAGE_DESCRIPTION, PropertyID.CHARACTER_DATA_DELAY, 2), new ExifTag(TAG_MAKE, PropertyID.APPEND_ENTER_DELAY, 2), new ExifTag(TAG_MODEL, PropertyID.CODE32_ENABLE, 2), new ExifTag(TAG_STRIP_OFFSETS, 273, 3, 4), new ExifTag(TAG_ORIENTATION, 274, 3), new ExifTag(TAG_SAMPLES_PER_PIXEL, 277, 3), new ExifTag(TAG_ROWS_PER_STRIP, 278, 3, 4), new ExifTag(TAG_STRIP_BYTE_COUNTS, 279, 3, 4), new ExifTag(TAG_X_RESOLUTION, 282, 5), new ExifTag(TAG_Y_RESOLUTION, 283, 5), new ExifTag(TAG_PLANAR_CONFIGURATION, 284, 3), new ExifTag(TAG_RESOLUTION_UNIT, 296, 3), new ExifTag(TAG_TRANSFER_FUNCTION, 301, 3), new ExifTag(TAG_SOFTWARE, 305, 2), new ExifTag(TAG_DATETIME, 306, 2), new ExifTag(TAG_ARTIST, 315, 2), new ExifTag(TAG_WHITE_POINT, 318, 5), new ExifTag(TAG_PRIMARY_CHROMATICITIES, 319, 5), new ExifTag(TAG_SUB_IFD_POINTER, 330, 4), new ExifTag(TAG_JPEG_INTERCHANGE_FORMAT, InputDeviceCompat.SOURCE_DPAD, 4), new ExifTag(TAG_JPEG_INTERCHANGE_FORMAT_LENGTH, 514, 4), new ExifTag(TAG_Y_CB_CR_COEFFICIENTS, 529, 5), new ExifTag(TAG_Y_CB_CR_SUB_SAMPLING, PropertyID.I25_ENABLE_CHECK, 3), new ExifTag(TAG_Y_CB_CR_POSITIONING, PropertyID.I25_SEND_CHECK, 3), new ExifTag(TAG_REFERENCE_BLACK_WHITE, 532, 5), new ExifTag(TAG_COPYRIGHT, 33432, 2), new ExifTag(TAG_EXIF_IFD_POINTER, 34665, 4), new ExifTag(TAG_GPS_INFO_IFD_POINTER, 34853, 4), new ExifTag(TAG_RW2_SENSOR_TOP_BORDER, 4, 4), new ExifTag(TAG_RW2_SENSOR_LEFT_BORDER, 5, 4), new ExifTag(TAG_RW2_SENSOR_BOTTOM_BORDER, 6, 4), new ExifTag(TAG_RW2_SENSOR_RIGHT_BORDER, 7, 4), new ExifTag(TAG_RW2_ISO, 23, 3), new ExifTag(TAG_RW2_JPG_FROM_RAW, 46, 7), new ExifTag(TAG_XMP, 700, 1)};
    ...
    private static final ExifTag[] ORF_CAMERA_SETTINGS_TAGS = {new ExifTag(TAG_ORF_PREVIEW_IMAGE_START, 257, 4), new ExifTag(TAG_ORF_PREVIEW_IMAGE_LENGTH, PropertyID.CODE39_ENABLE_CHECK, 4)};
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private ExifInterface(java.io.InputStream r3, boolean r4) throws java.io.IOException {
        /*
            r2 = this;
            r2.<init>()
            ...
            if ((i4 != 4 || this.mHasThumbnail) && (exifTag = sExifTagMapsForWriting[i4].get(str5)) != null) {
                if (string == null) {
                    ...
                    switch (i) {
                        case 1:
                            str3 = str6;
                            this.mAttributes[i4].put(str5, ExifAttribute.createByte(string));
                            str6 = str3;
                            break;
                        case 2:
                        case 7:
                            str3 = str6;
                            this.mAttributes[i4].put(str5, ExifAttribute.createString(string));
                            str6 = str3;
                            break;
                        case 3:
                            str3 = str6;
    ...
    public void rotate(int i) throws NumberFormatException {
        ...
        if (ROTATION_ORDER.contains(Integer.valueOf(attributeInt))) {
            int iIndexOf = (ROTATION_ORDER.indexOf(Integer.valueOf(attributeInt)) + (i / 90)) % 4;
            ...
            int iIndexOf2 = (FLIPPED_ROTATION_ORDER.indexOf(Integer.valueOf(attributeInt)) + (i / 90)) % 4;
    ...
    /* JADX WARN: Type inference failed for: r7v10, types: [java.io.FileOutputStream, java.io.OutputStream] */
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:39:0x0068 A[Catch: all -> 0x009b, Exception -> 0x009d, TRY_ENTER, TRY_LEAVE, TryCatch #8 {Exception -> 0x009d, all -> 0x009b, blocks: (B:39:0x0068, B:42:0x0078, B:44:0x0084, B:49:0x008f, B:50:0x0094, B:51:0x0095, B:52:0x009a, B:57:0x00a2, B:58:0x00a7), top: B:78:0x0066 }] */
    /* JADX WARN: Removed duplicated region for block: B:57:0x00a2 A[Catch: all -> 0x009b, Exception -> 0x009d, TryCatch #8 {Exception -> 0x009d, all -> 0x009b, blocks: (B:39:0x0068, B:42:0x0078, B:44:0x0084, B:49:0x008f, B:50:0x0094, B:51:0x0095, B:52:0x009a, B:57:0x00a2, B:58:0x00a7), top: B:78:0x0066 }] */
    ...
    */
    ...
    public Bitmap getThumbnailBitmap() throws Throwable {
        ...
        if (i == 1) {
            ...
            for (int i2 = 0; i2 < iArr.length; i2++) {
                ...
                int i3 = i2 * 3;
                iArr[i2] = (bArr[i3] << CmdCenter.CMD_openMoreCabinet) + 0 + (bArr[i3 + 1] << 8) + bArr[i3 + 2];
            }
    ...
    private static long parseDateTime(String str, String str2) throws NumberFormatException {
    ...
    */
    ...
    private void savePngAttributes(InputStream inputStream, OutputStream outputStream) throws Throwable {
        ...
        if (i == 0) {
            ...
            copy(dataInputStream, byteOrderedDataOutputStream, i2 + 4 + 4);
        } else {
                ...
                try {
                    ...
                    if (this.mExifOffset != 0) {
                        ...
                        if (Arrays.equals(bArr, WEBP_CHUNK_TYPE_VP8X)) {
                            int i = byteOrderedDataInputStream.readInt();
                            boolean z = true;
                            byte[] bArr2 = new byte[i % 2 == 1 ? i + 1 : i];
                            byteOrderedDataInputStream.read(bArr2);
    ...
    */
    ...
    private void handleThumbnailFromStrips(ByteOrderedDataInputStream byteOrderedDataInputStream, HashMap map) throws IOException {
        ...
        for (int i2 = 0; i2 < jArrConvertToLongArray.length; i2++) {
            ...
            if (i2 < jArrConvertToLongArray.length - 1 && i3 + i4 != jArrConvertToLongArray[i2 + 1]) {
    ...
    private int writeExifSegment(ByteOrderedDataOutputStream byteOrderedDataOutputStream) throws IOException {
        ...
        while (i8 < EXIF_TAGS.length) {
            if (!this.mAttributes[i8].isEmpty()) {
                ...
                int size3 = iArr[i8] + i2 + (this.mAttributes[i8].size() * 12) + 4;
