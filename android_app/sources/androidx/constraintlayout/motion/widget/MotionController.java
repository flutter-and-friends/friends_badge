...
public class MotionController {
    ...
    public void setup(int i, int i2, float f, long j) {
            ...
            for (int i16 = 0; i16 < motionPathsArr.length; i16++) {
                if (motionPathsArr[i16].hasCustomData(str8)) {
                    if (dArr4 == null) {
                        ...
                        dArr4 = (double[][]) Array.newInstance((Class<?>) double.class, motionPathsArr.length, motionPathsArr[i16].getCustomDataCount(str8));
                    }
                    dArr3[i15] = motionPathsArr[i16].time;
                    motionPathsArr[i16].getCustomData(str8, dArr4[i15], 0);
                    i15++;
                }
            }
            i14++;
        ...
        if (motionPathsArr[0].mPathMotionArc != Key.UNSET) {
            ...
            for (int i17 = 0; i17 < length; i17++) {
                ...
                dArr6[i17][0] = motionPathsArr[i17].f30x;
                dArr6[i17][1] = motionPathsArr[i17].f31y;
            }
    ...
    public String toString() {
        return " start: x: " + this.mStartMotionPath.f30x + " y: " + this.mStartMotionPath.f31y + " end: x: " + this.mEndMotionPath.f30x + " y: " + this.mEndMotionPath.f31y;
    }
    ...
    boolean interpolate(View view, float f, long j, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            float f2 = this.mStartMotionPath.f30x + ((this.mEndMotionPath.f30x - this.mStartMotionPath.f30x) * adjustedPosition);
            float f3 = this.mStartMotionPath.f31y + ((this.mEndMotionPath.f31y - this.mStartMotionPath.f31y) * adjustedPosition);
            float f4 = f2 + 0.5f;
            int i3 = (int) f4;
            float f5 = f3 + 0.5f;
            int i4 = (int) f5;
