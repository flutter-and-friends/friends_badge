...
public class VerticalWidgetRun extends WidgetRun {
    ...
    static /* synthetic */ class C01511 {
        ...
        static final /* synthetic */ int[] f44xbf6f0c8e = new int[WidgetRun.RunType.values().length];

        static {
            try {
                f44xbf6f0c8e[WidgetRun.RunType.START.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f44xbf6f0c8e[WidgetRun.RunType.END.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f44xbf6f0c8e[WidgetRun.RunType.CENTER.ordinal()] = 3;
    ...
    public void update(Dependency dependency) {
        ...
        int i;
        int i2 = C01511.f44xbf6f0c8e[this.mRunType.ordinal()];
        if (i2 == 1) {
