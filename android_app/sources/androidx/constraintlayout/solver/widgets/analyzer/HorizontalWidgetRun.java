...
public class HorizontalWidgetRun extends WidgetRun {
    ...
    static /* synthetic */ class C01501 {
        ...
        static final /* synthetic */ int[] f43xbf6f0c8e = new int[WidgetRun.RunType.values().length];

        static {
            try {
                f43xbf6f0c8e[WidgetRun.RunType.START.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f43xbf6f0c8e[WidgetRun.RunType.END.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f43xbf6f0c8e[WidgetRun.RunType.CENTER.ordinal()] = 3;
