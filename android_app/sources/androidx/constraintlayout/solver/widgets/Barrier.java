...
public class Barrier extends HelperWidget {
    ...
    public void addToSolver(LinearSystem linearSystem, boolean z) {
        ...
        if (this.resolved) {
            ...
            if (i5 == 0 || i5 == 1) {
                linearSystem.addEquality(this.mLeft.mSolverVariable, this.f36mX);
                linearSystem.addEquality(this.mRight.mSolverVariable, this.f36mX);
                return;
            } else {
                if (i5 == 2 || i5 == 3) {
                    linearSystem.addEquality(this.mTop.mSolverVariable, this.f37mY);
                    linearSystem.addEquality(this.mBottom.mSolverVariable, this.f37mY);
                    return;
                }
                return;
            }
