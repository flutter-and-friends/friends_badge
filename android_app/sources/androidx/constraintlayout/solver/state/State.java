...
public class State {
    ...
    public HelperReference helper(Object obj, Helper helper) {
        ...
        if (helperReference == null) {
            int i = C01431.$SwitchMap$androidx$constraintlayout$solver$state$State$Helper[helper.ordinal()];
            if (i == 1) {
    ...
    static /* synthetic */ class C01431 {
        ...
        static {
            try {
                $SwitchMap$androidx$constraintlayout$solver$state$State$Helper[Helper.HORIZONTAL_CHAIN.ordinal()] = 1;
