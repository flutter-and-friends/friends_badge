...
public abstract class ConstraintHelper extends View {
    ...
    protected void init(AttributeSet attributeSet) {
        if (attributeSet != null) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                if (index == C0159R.styleable.ConstraintLayout_Layout_constraint_referenced_ids) {
                    this.mReferenceIds = typedArrayObtainStyledAttributes.getString(index);
                    setIds(this.mReferenceIds);
                } else if (index == C0159R.styleable.ConstraintLayout_Layout_constraint_referenced_tags) {
    ...
    private int findId(String str) throws IllegalAccessException, Resources.NotFoundException, IllegalArgumentException {
        ...
        if (iFindId == 0) {
            try {
                iFindId = C0159R.id.class.getField(str).getInt(null);
