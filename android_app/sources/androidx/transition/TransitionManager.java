...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo920clone = transition.mo920clone();
        transitionMo920clone.setSceneRoot(sceneRoot);
        Scene currentScene = Scene.getCurrentScene(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo920clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo920clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo920clone);
    }
    ...
    /* renamed from: go */
    public static void m10go(Scene scene) {
        changeScene(scene, sDefaultTransition);
    }

    /* renamed from: go */
    public static void m11go(Scene scene, Transition transition) {
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo920clone = transition.mo920clone();
        sceneChangeSetup(viewGroup, transitionMo920clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo920clone);
    }
