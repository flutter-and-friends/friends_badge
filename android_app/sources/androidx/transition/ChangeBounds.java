...
public class ChangeBounds extends Transition {
    ...
    @Override // androidx.transition.Transition
    public Animator createAnimator(final ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        int i;
        final View view;
        int i2;
        Rect rect;
        ...
        if (parentMatches(viewGroup2, viewGroup3)) {
            ...
            if (view.getParent() instanceof ViewGroup) {
                ...
                addListener(new TransitionListenerAdapter() { // from class: androidx.transition.ChangeBounds.9
                    ...
                    public void onTransitionCancel(Transition transition) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
