...
class AdapterHelper implements OpReorderer.Callback {
    ...
    private void dispatchAndUpdateViewHolders(UpdateOp updateOp) {
        ...
        for (int i7 = 1; i7 < updateOp.itemCount; i7++) {
            int iUpdatePositionWithPostponed2 = updatePositionWithPostponed(updateOp.positionStart + (i * i7), updateOp.cmd);
            int i8 = updateOp.cmd;
            if (i8 == 2 ? iUpdatePositionWithPostponed2 == i4 : i8 == 4 && iUpdatePositionWithPostponed2 == i4 + 1) {
                i6++;
            } else {
                UpdateOp updateOpObtainUpdateOp = obtainUpdateOp(updateOp.cmd, i4, i6, updateOp.payload);
        ...
        recycleUpdateOp(updateOp);
        if (i6 > 0) {
            UpdateOp updateOpObtainUpdateOp2 = obtainUpdateOp(updateOp.cmd, i4, i6, obj);
