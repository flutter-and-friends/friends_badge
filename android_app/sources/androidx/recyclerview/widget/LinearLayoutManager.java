...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        if (this.mAnchorInfo.mLayoutFromEnd) {
            ...
            layoutState3.mExtraFillSpace = iMax2;
            ...
            if (this.mLayoutState.mAvailable > 0) {
                ...
                layoutState4.mExtraFillSpace = i9;
            ...
            layoutState5.mExtraFillSpace = iMax2;
            ...
            layoutState6.mExtraFillSpace = iMax;
            layoutState6.mCurrentPosition += this.mLayoutState.mItemDirection;
            fill(recycler, this.mLayoutState, state, false);
            i2 = this.mLayoutState.mOffset;
            if (this.mLayoutState.mAvailable > 0) {
                ...
                layoutState7.mExtraFillSpace = i11;
