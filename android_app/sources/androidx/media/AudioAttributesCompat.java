...
public class AudioAttributesCompat implements VersionedParcelable {
    ...
    public static AudioAttributesCompat fromBundle(Bundle bundle) {
        AudioAttributesImpl audioAttributesImplFromBundle;
        if (Build.VERSION.SDK_INT >= 21) {
            audioAttributesImplFromBundle = AudioAttributesImplApi21.fromBundle(bundle);
        } else {
            audioAttributesImplFromBundle = AudioAttributesImplBase.fromBundle(bundle);
        }
