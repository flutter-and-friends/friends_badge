...
public class PaddingViewAttrs {
    public static void obtainsAttrs(Context context, View view, AttributeSet attributeSet) {
        ...
        TypedArray typedArrayObtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, cn.forward.androids.R.styleable.PaddingViewAttrs);
        int dimensionPixelOffset3 = typedArrayObtainStyledAttributes2.getDimensionPixelOffset(cn.forward.androids.R.styleable.PaddingViewAttrs_vp_content_width, 0);
        int dimensionPixelOffset4 = typedArrayObtainStyledAttributes2.getDimensionPixelOffset(cn.forward.androids.R.styleable.PaddingViewAttrs_vp_content_height, 0);
        int dimensionPixelOffset5 = typedArrayObtainStyledAttributes2.getDimensionPixelOffset(cn.forward.androids.R.styleable.PaddingViewAttrs_vp_content_padding_left, -1);
        int dimensionPixelOffset6 = typedArrayObtainStyledAttributes2.getDimensionPixelOffset(cn.forward.androids.R.styleable.PaddingViewAttrs_vp_content_padding_top, -1);
        int dimensionPixelOffset7 = typedArrayObtainStyledAttributes2.getDimensionPixelOffset(cn.forward.androids.R.styleable.PaddingViewAttrs_vp_content_padding_right, -1);
        int dimensionPixelOffset8 = typedArrayObtainStyledAttributes2.getDimensionPixelOffset(cn.forward.androids.R.styleable.PaddingViewAttrs_vp_content_padding_bottom, -1);
