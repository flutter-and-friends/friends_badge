...
public class BitmapScrollPicker extends ScrollPickerView<Bitmap> {
    ...
    private void init(AttributeSet attributeSet) {
        if (attributeSet != null) {
            TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, R.styleable.BitmapScrollPicker);
            this.mDrawMode = typedArrayObtainStyledAttributes.getInt(R.styleable.BitmapScrollPicker_spv_draw_bitmap_mode, this.mDrawMode);
            this.mSpecifiedSizeWidth = typedArrayObtainStyledAttributes.getDimensionPixelOffset(R.styleable.BitmapScrollPicker_spv_draw_bitmap_width, this.mSpecifiedSizeWidth);
            this.mSpecifiedSizeHeight = typedArrayObtainStyledAttributes.getDimensionPixelOffset(R.styleable.BitmapScrollPicker_spv_draw_bitmap_height, this.mSpecifiedSizeHeight);
            this.mMinScale = typedArrayObtainStyledAttributes.getFloat(R.styleable.BitmapScrollPicker_spv_min_scale, this.mMinScale);
            this.mMaxScale = typedArrayObtainStyledAttributes.getFloat(R.styleable.BitmapScrollPicker_spv_max_scale, this.mMaxScale);
