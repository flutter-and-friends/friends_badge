...
public class ShapeImageView extends ImageView {
    ...
    private void init(AttributeSet attributeSet) {
        TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, R.styleable.ShapeImageView);
        this.mShape = typedArrayObtainStyledAttributes.getInt(R.styleable.ShapeImageView_siv_shape, this.mShape);
        this.mRoundRadius = typedArrayObtainStyledAttributes.getDimension(R.styleable.ShapeImageView_siv_round_radius, this.mRoundRadius);
        this.mBorderSize = typedArrayObtainStyledAttributes.getDimension(R.styleable.ShapeImageView_siv_border_size, this.mBorderSize);
        this.mBorderColor = typedArrayObtainStyledAttributes.getColor(R.styleable.ShapeImageView_siv_border_color, this.mBorderColor);
        this.mRoundRadiusLeftBottom = typedArrayObtainStyledAttributes.getDimension(R.styleable.ShapeImageView_siv_round_radius_leftBottom, this.mRoundRadius);
        this.mRoundRadiusLeftTop = typedArrayObtainStyledAttributes.getDimension(R.styleable.ShapeImageView_siv_round_radius_leftTop, this.mRoundRadius);
        this.mRoundRadiusRightBottom = typedArrayObtainStyledAttributes.getDimension(R.styleable.ShapeImageView_siv_round_radius_rightBottom, this.mRoundRadius);
        this.mRoundRadiusRightTop = typedArrayObtainStyledAttributes.getDimension(R.styleable.ShapeImageView_siv_round_radius_rightTop, this.mRoundRadius);
