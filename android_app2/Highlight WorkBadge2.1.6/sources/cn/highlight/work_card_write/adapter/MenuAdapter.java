...
public class MenuAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new Holder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_menu, viewGroup, false));
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int i) {
        if (viewHolder instanceof Holder) {
            ...
            if (menu.isSelected()) {
                holder.tv_content.setBackgroundColor(this.context.getResources().getColor(R.color.device));
                holder.tv_content.setTextColor(this.context.getResources().getColor(R.color.white));
            } else {
                holder.tv_content.setBackgroundColor(this.context.getResources().getColor(R.color.white));
    ...
    class Holder extends RecyclerView.ViewHolder {
        ...
        Holder(View view) {
            ...
            this.v_lin = view.findViewById(R.id.v_lin);
        }
    }
