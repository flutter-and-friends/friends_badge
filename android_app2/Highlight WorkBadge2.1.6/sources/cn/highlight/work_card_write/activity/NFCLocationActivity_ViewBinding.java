...
public class NFCLocationActivity_ViewBinding implements Unbinder {
    ...
    public NFCLocationActivity_ViewBinding(final NFCLocationActivity nFCLocationActivity, View view) {
        ...
        nFCLocationActivity.imgBack = (ImageView) Utils.castView(viewFindRequiredView, R.id.imgBack, "field 'imgBack'", ImageView.class);
        ...
        View viewFindRequiredView2 = Utils.findRequiredView(view, R.id.linearIphone, "field 'linearIphone' and method 'onViewClicked'");
        nFCLocationActivity.linearIphone = (LinearLayout) Utils.castView(viewFindRequiredView2, R.id.linearIphone, "field 'linearIphone'", LinearLayout.class);
        ...
        View viewFindRequiredView3 = Utils.findRequiredView(view, R.id.linearHUAWEI, "field 'linearHUAWEI' and method 'onViewClicked'");
        nFCLocationActivity.linearHUAWEI = (LinearLayout) Utils.castView(viewFindRequiredView3, R.id.linearHUAWEI, "field 'linearHUAWEI'", LinearLayout.class);
        ...
        View viewFindRequiredView4 = Utils.findRequiredView(view, R.id.linearXiaoMi, "field 'linearXiaoMi' and method 'onViewClicked'");
        nFCLocationActivity.linearXiaoMi = (LinearLayout) Utils.castView(viewFindRequiredView4, R.id.linearXiaoMi, "field 'linearXiaoMi'", LinearLayout.class);
        ...
        View viewFindRequiredView5 = Utils.findRequiredView(view, R.id.linearSanXing, "field 'linearSanXing' and method 'onViewClicked'");
        nFCLocationActivity.linearSanXing = (LinearLayout) Utils.castView(viewFindRequiredView5, R.id.linearSanXing, "field 'linearSanXing'", LinearLayout.class);
        ...
        View viewFindRequiredView6 = Utils.findRequiredView(view, R.id.linearOppo, "field 'linearOppo' and method 'onViewClicked'");
        nFCLocationActivity.linearOppo = (LinearLayout) Utils.castView(viewFindRequiredView6, R.id.linearOppo, "field 'linearOppo'", LinearLayout.class);
        ...
        View viewFindRequiredView7 = Utils.findRequiredView(view, R.id.linearVivo, "field 'linearVivo' and method 'onViewClicked'");
        nFCLocationActivity.linearVivo = (LinearLayout) Utils.castView(viewFindRequiredView7, R.id.linearVivo, "field 'linearVivo'", LinearLayout.class);
