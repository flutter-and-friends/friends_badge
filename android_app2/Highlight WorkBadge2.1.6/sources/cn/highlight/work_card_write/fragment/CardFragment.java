...
public class CardFragment extends BaseFragment {
    ...
    @BindView(R.id.card_model_tv)
    TextView cardModelTv;

    @BindView(R.id.card_model_tv1)
    TextView cardModelTv1;

    @BindView(R.id.card_theme_tv)
    TextView cardThemeTv;

    @BindView(R.id.card_theme_tv1)
    TextView cardThemeTv1;

    @BindView(R.id.card_title_model)
    RelativeLayout cardTitleModel;

    @BindView(R.id.card_title_theme)
    RelativeLayout cardTitleTheme;
    private List<BadgeBean> dataList;

    @BindView(R.id.linearModel)
    LinearLayout linearModel;

    @BindView(R.id.linearTheme)
    ...
    @BindView(R.id.modelSelectSize)
    LinearLayout modelSelectSize;

    @BindView(R.id.modelSize)
    TextView modelSize;

    @BindView(R.id.modelTabLayout)
    TabLayout modelTabLayout;
    private NfcAdapter nfcAdapter;
    private BottomSheetDialog nfcDialog;

    @BindView(R.id.nfcLinear)
    ImageView nfcLinear;

    @BindView(R.id.themTabLayout)
    ...
    private void initShow(String str) {
        if (str.equals("模板")) {
            this.cardModelTv.setTextColor(getResources().getColor(R.color.text_color_3));
            this.cardModelTv1.setVisibility(0);
            this.cardThemeTv.setTextColor(getResources().getColor(R.color.text_color_5));
        ...
        this.cardModelTv.setTextColor(getResources().getColor(R.color.text_color_5));
        this.cardModelTv1.setVisibility(4);
        this.cardThemeTv.setTextColor(getResources().getColor(R.color.text_color_3));
    ...
    @OnClick({R.id.card_title_model, R.id.card_title_theme, R.id.modelSelectSize, R.id.themeSelectSize, R.id.nfcLinear})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.card_title_model /* 2131296422 */:
                initShow("模板");
                initModel();
                break;
            case R.id.card_title_theme /* 2131296423 */:
                initShow("主题");
                initTheme();
                break;
            case R.id.modelSelectSize /* 2131296703 */:
                showSizeDialog("model");
                break;
            case R.id.nfcLinear /* 2131296714 */:
                showStartNFCDialog();
                initNFC();
                break;
            case R.id.themeSelectSize /* 2131296907 */:
    ...
    private void showSizeDialog(final String str) {
        View viewInflate = LayoutInflater.from(getContext()).inflate(R.layout.dialog_select_size_card_item, (ViewGroup) null);
        TextView textView = (TextView) viewInflate.findViewById(R.id.tvCancel);
        TextView textView2 = (TextView) viewInflate.findViewById(R.id.tvSure);
        final CycleWheelView cycleWheelView = (CycleWheelView) viewInflate.findViewById(R.id.wheelViewSize);
        final BottomSheetDialog bottomSheetDialog = new BottomSheetDialog((Context) Objects.requireNonNull(getContext()), R.style.CustomBottomSheetStyle);
